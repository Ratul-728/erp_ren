        ...
        <div class="container-fluid pagetop">
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <?php include_once('phpajax/load_cus_order_view.php'); ?> 
        <!-- /#end of panel -->    
...
<?php }}?>                    
                        ...
                        <input  dat a-to="pagetop" class="btn btn-lg btn-default top" type="submit" name="edit" value="Edit" id="edit">
                        <input  dat a-to="pagetop" class="btn btn-lg btn-default top" type="submit" name="confirm" value="Confirm" id="confirm" >
                        <?php } else {?> 
                        <input  dat a-to="pagetop" class="btn btn-lg btn-default top" type="submit" name="home" value="&larr; Order Management" id="home" >
