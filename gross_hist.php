            ...
            <div class="container-fluid pagetop">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>
                           <form method="post" action="common/addgross_hist.php" id="form1" enctype="multipart/form-data">
            			            ...
            			            <div class="panel-body panel-body-padding">
                                        ...
                                        <div class="row form-header">
	                                        <div class="col-lg-6 col-md-6 col-sm-6">
          		                                <h6>HRM <i class="fa fa-angle-right"></i>HR Operation <i class="fa fa-angle-right"></i> Gross Salary History</h6>
          		                            </div>
      		                                <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <?php if ($mode == 2) { ?>
                                                <input  dat a-to="pagetop" class="btn btn-lg btn-default top" type="submit" name="update" value="Update Gross Salary" id="update" >
                                                <?php } ?>
                                                <a href = "./gross_histList.php?pg=1&mod=4">
