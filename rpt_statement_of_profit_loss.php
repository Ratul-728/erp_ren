...
else
{
  ...
  if ( isset( $_POST['export'] ) ) 
  {
    ...
    $currSection = 'rpt_statement_of_profit_loss';
            ...
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <p>
                     ...
                     <form method="post" action="rpt_statement_of_profit_loss.php?pg=1&mod=7" id="form1" enctype="multipart/form-data">  
...
<?php } ?>                    
                            ...
                            <?php include_once('phpajax/rpt_load_profit_loss_statment.php'); ?> 
        <!-- /#end of panel -->
                    </form>
