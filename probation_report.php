...
else
{
   ...
   if ( isset( $_POST['export'] ) ) {
        ...
        $month = $_POST["month"]; if($month != 0) $monthqry = "AND MONTH(h.effective_to) = ".$month;

        $year = $_POST["year"];   if($year != 0) $yearqry = "AND YEAR(h.effective_to) = ".$year;
        ...
        $objPHPExcel->setActiveSheetIndex(0)
    			...
    			->setCellValue('E1', 'Date of Joining')
    			->setCellValue('F1', 'Probation Ending Time');
                  
    			
        $firststyle='A2';
        $qry="SELECT CONCAT(emp.firstname, ' ', emp.lastname) AS empnm, emp.employeecode, d.name deptnm,
                                ...
                                WHERE h.actiontype = 1 AND jt.ID = 1 $monthqry $yearqry  GROUP BY h.hrid"; 
       // echo  $qry;die;
        ...
        { $i=0;
            ...
            { 
                ...
                $objPHPExcel->setActiveSheetIndex(0)
    					    ...
    					    ->setCellValue($col5, $row["actiondt"])
    					    ->setCellValue($col6, $row["effective_to"]);
    					     
    					    	/* */
    			//$laststyle=$title;	
            }
        }
        $objPHPExcel->getActiveSheet()->setTitle('PROBATION_REPORT');
        $objPHPExcel->setActiveSheetIndex(0);
        $today=date("YmdHis");
        $fileNm="data/".'probation_report'.$today.'.xls'; 
                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                        ...
                        <div class="col-sm-3 text-nowrap">
                            <h6>HRM <i class="fa fa-angle-right"></i>Probation Report</h6>
                       </div>
  ...
  <div class="col-sm-9 text-nowrap"> 
                        ...
                        <div class="pull-right grid-panel form-inline">
                                ...
                                <div class="form-group">
  									<label for="">Filter by Probation Ending Time: </label>
                                </div>
...
?>
     ...
     <!-- Datatable JS -->       
		...
		url = 'phpajax/datagrid_list_all.php?action=probation_report';
        ...
        $("#month, #year").on("change", function() {
			...
			url = 'phpajax/datagrid_list_all.php?action=probation_report&month='+month+'&year='+year;
