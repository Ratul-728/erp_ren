...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/deliveryTransferQA.php?res=0&msg='Insert Data'&mod=3");
    }
...
//			}],
    ...
    url = 'phpajax/datagrid_delivery.php?action=deliverytransferqa';
	table_with_filter(url);	
        ...
        $("#cmbstatus").on("change", function() {
			...
			url = 'phpajax/datagrid_delivery.php?action=deliveryissueqa&cmbstatus='+status;
