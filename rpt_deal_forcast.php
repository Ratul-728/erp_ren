          ...
          <div class="row">
            ...
            <p>&nbsp;</p>
              ...
              <div class="panel panel-info">
      			<!-- <div class="panel-heading"><h1 class="left-align">All Deals</h1></div> -->
                	...
                	<form method="post" action="rpt_deal_forcast.php" id="form1">
                     ...
                     <div class="well list-top-controls">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>CRM <i class="fa fa-angle-right"></i>All Deals Report </h6>
                       </div>
...
function table_with_filter(url){
	...
	url = 'phpajax/datagrid_report.php?action=deal_forcast';
	table_with_filter(url);	
		...
		//convert pdf trigger;
			...
			$("#exportpdf").on("click",function(){
				...
				var pdfurl = "pdf_deals_report.php";
