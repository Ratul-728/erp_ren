...
else
{
    ...
    */
    ...
    if ( isset( $_POST['export'] ) ) {
        ...
        $qry1="SELECT DATE_FORMAT(q.orderdate,'%m/%d/%Y') AS date, q.socode order_id, o.name AS customer, 
       ...
       // echo  $qry;die;
        ...
        { $i=0;$tcp=0;$tmp=0;
            ...
            { 
                ...
                $dateValue = PHPExcel_Shared_Date::PHPToExcel(strtotime($row['date']));
