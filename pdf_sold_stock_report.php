...
$loop = "";
    $qry="SELECT s.`id`, s.`socode`,tp.`name` `srctype`,c.`name` `customer`,o.`name` organization, date_format(s.`orderdate`,'%d/%m/%y') `orderdate`,
                                        ...
                                        WHERE s.orderstatus=3 ORDER BY  s.id DESC";
    	  //echo  $qry;die;
...
$obj_pdf->SetTitle("Sold Stock Report");
...
<table width="100%" border="0"  cellspacing="0" cellpadding="0">
   <thead>
	<tr>
		...
		<td width="50%" align="right"><h1>Sold Stock Report</h1></td>
	</tr>
	</thead>		
</table>		
...
$obj_pdf->OutPut("Sold_stock_Report","I");
//echo $content;
}
?>
