...
?>
                       ...
                       <!-- <div class="col-sm-1 text-nowrap">
                        ...
                        <div class="col-sm-11 text-nowrap"> 
                           ...
                           <!-- <div class="form-group">
                            ...
                            <!-- <button type="submit" title="Announce" name="announce" id="announce" class="form-control btn btn-default"><i class="fas fa-bullhorn"></i></button>
                            </div> -->
                             <div class="form-group">
                            <!--input class="btn btn-default form-control" type="submit" name="export" value=" Export Data" id="export"  -->
                            <button type="submit" title="Announce" name="announce" id="announce" class="form-control btn btn-default"><i class="fas fa-bullhorn"></i></button>
                            ...
                            <div class="form-group">
                            <!--input class="btn btn-default form-control" type="submit" name="export" value=" Export Data" id="export"  -->
                            <button type="submit" title="SMS" name="sms" id="sms" class="form-control btn btn-default"><i class="far fa-envelope"></i></button>
                            </div>
                            
                           <!-- <input class="btn btn-md btn-info   pull-right responsive-alignment-r2l" type="submit" name="export" value=" Export Data" id="export"  > -->
                            <div class="form-group">
                            <!--input class="btn btn-default form-control" type="submit" name="export" value=" Export Data" id="export"  -->
                            <button type="submit" title="export" name="export" id="export" class="form-control btn btn-default"><i class="fas fa-download"></i></button>
                            </div>
	...
	<?php 
    $qry1="SELECT `id`,`name` FROM `organization`  order by `name` ";  $result1 = $conn->query($qry1);   if ($result1->num_rows > 0) { while($row1 = $result1->fetch_assoc())
    { 
	...
	<?php 
    $qry1="SELECT `id`,`name` FROM `issuetype`  order by `name`";  $result1 = $conn->query($qry1);   if ($result1->num_rows > 0) { while($row1 = $result1->fetch_assoc())
    { 
              $issid= $row1["id"];  $issnm=$row1["name"];
    ?>           
...
<link href='js/plugins/datagrid/datatables.css' rel='stylesheet' type='text/css'>                   
                ...
                <div >
                    <!-- Table 
                    <table id='l istTable' class='display dataTable actionbtn' width="100%">
                        <thead>
                        <tr>
                            <th>Action</th>
                            <th>Oganization </th>
                    ...
                    <table class="my_table">
                     <thdead> <tr>
                      ...
                      <tr class="data-row">
                        ...
                        <td>text</td>
                        <td>text</td>
                         <td>textsdf sdf sdv sdfv sdfv</td>
                        <td>text</td>
                        <td>text</td>
                        <td>text</td>
                         <td>text</td>
                        <td>textasxas asx dfge df</td>
                        <td>text</td>
                        <td>text</td>
                         <td>text</td>
                        <td>text</td>
	        ...
	        $.ajax({
				...
				success:function(res)
				{
				    if(pval == 3){
				        ...
				        var link = "common/delobj.php?obj=issueticket&ret=issueadminList&mod=6&id="+pid;
				    }
