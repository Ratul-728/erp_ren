                                            ...
                                            <form method="post" action="common/update_profile.php"  id="form1" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <div class="lab-form-group">
                                                                ...
                                                                <input type="text" class=" ed-info-box" id="cd" name="cd" value="<?php echo $empcode;?>" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="lab-form-group">
                                                                <label for="fnm">First Name*</label>
                                                                <input type="text" class=" ed-info-box" id="fnm" name="fnm" value="<?php echo $firstname;?>" readonly>
                                                        ...
                                                        <div class="col-sm-3">
                                                           <div class="lab-form-group">
                                                                ...
                                                                <input type="text" class=" ed-info-box" id="lnm" name="lnm" value="<?php echo $lastname;?>" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="lab-form-group">
                                                            <label for="dob">Date of Birth</label>
                                                                <input type="text" class=" ed-info-box datepicker" id="dob" name="dob" value="<?php echo $dob;?>" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="lab-form-group">
                                                                ...
                                                                <div class="lab-form-group pdd">
                                                                    <select name="cmbdsg"  class="ed-info-box" readonly>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="lab-form-group">
                                                                ...
                                                                <div class="lab-form-group pdd">
                                                                    <select name="cmbmartial"  class=" ed-info-box" readonly>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="lab-form-group">
                                                                ...
                                                                <input type="text" class=" ed-info-box" id="nid" name="nid" value="<?php echo $nid;?>" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="lab-form-group">
                                                                <label for="email">TIN</label>
                                                                <input type="text" class=" ed-info-box" id="tin" name="tin" value="<?php echo $tin;?>" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="lab-form-group">
                                                                ...
                                                                <div class="lab-form-group pdd">
                                                                    <select name="cmbbg"  class=" ed-info-box" readonly>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="lab-form-group">
                                                                ...
                                                                <input type="text" class=" ed-info-box" id="pp" name="pp" value="<?php echo $pp;?>" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="lab-form-group">
                                                                <label for="drvid">Driving Licence</label>
                                                                <input type="text" class=" ed-info-box" id="drvid" name="drvid" value="<?php echo $drivinglicense;?>" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <?php  }}?>                                                       
                                                ...
                                                <div class="contact">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="lab-form-group">
                                                                ...
                                                                <input type="text" class=" ed-info-box" id="per_cont" name="per_cont" value="<?php echo $pers_contact;?>" minlength="8" maxlength="12" >
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <div class="lab-form-group">
                                                    ...
                                                    <div class="cus-button-bar">
                                	                        ...
                                	                        <input  dat a-to="pagetop" class="btn cus-btn" type="submit" name="update" value="Update Profile"  id="update" > <!-- onclick="javascript:messageAlert('Event is fired from the page and messaged is pased via parameter. will be desolve in 5 sec')" -->
