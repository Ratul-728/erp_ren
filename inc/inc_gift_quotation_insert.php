                                                <div class="row form-grid-bls  hidden-md hidden-sm hidden-xs">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-6">
                                                            <h6 class="chalan-header"> Total </h6>
                                                        </div-->
                                                </div>
        	                                        ...
        	                                        <div class="toClone">
                                                        ...
                                                        <input type="hidden" class="numonly form-control unitprice_otc1_ unitPriceV2_ calc c-price" id="unitprice_otc1_" value="0.00" placeholder="Price" name="unitprice_otc[]" disabled>
        														<input type="hidden" class="form-control unitprice_otc_ unitPriceV2_" id="unitprice_otc_" name="unitprice_otc1[]">
        
        												<input type="hidden" min="0" max="100"  class="numonly calc c-discount form-control discnt_" id="discnt_"   placeholder="Discount %" name="discnt[]">
        												<input type="hidden"  class="numonly form-control vat_ calc c-vat" id="vat_" placeholder="VAT%" name="vat[]">
                                                        <input type="hidden" class="form-control TotalAmount_ c-price-utt" id="total_" placeholder="Unit Total" readonly  name="total[]">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-5">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="hidden" st yle="width: 200px;"  class="form-control unitTotalAmount1_ c-discounted-ttl" id="unittotal1_ " placeholder="Discounted Total " readonly  name="unittotal1[]">
