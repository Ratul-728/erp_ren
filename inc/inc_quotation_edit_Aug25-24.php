			...
			<div class="row border">
                        ...
                        <div class="col-xs-4">
                              <div class="input-group plusminuswrap">
                                ...
                                <input type="text" id="quantity_<?=$pid?>_<?=$wh['id']?>" name="whqty[<?=$pid?>][]" class="form-control input-number numonly quantity"  value="<?=($curQty>0)?$curQty:'0'?>" min="0" max="<?=$wh['quantity']?>">
                                <span class="input-group-btn">
                                                                            ...
                                                                            <div class="toClone" data-order_detail_id="<?=$order_detail_id?>">
                                                                                    ...
                                                                                    <div class="col-lg-1 col-md-1 col-sm-5 col-xs-4">
                                                                                        ...
                                                                                        <div class="form-group qtnqrapper">
                                                                                            <input type="text" data-stock="<?=$freeqty?>"  autocomplete="off" <?=($freeqty == 0)?'style="border:1px solid red;"':''?>  required class="calc c-qty form-control quantity_otc_"  id_="quantity_otc" value="<?php echo $itdqu; ?>" name="quantity_otc[]">
                                                                                            <?php
                                                                                                    $whParams = array();
                                                                                    ...
                                                                                    <div class="col-lg-1 col-md-1 col-sm-1  col-xs-2">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-sm-12 col-xs-12">
                                                                                                <div class="form-group">
                                                                                                    <input type="text"  min="0.00" step="any" class="numonly calc c-discount form-control discnt_" id_="discnt"  placeholder="Discount%" value="<?php echo $discountrate; ?>" name="discnt[]" >
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>												
