			...
			<div class="row border">
                        ...
                        <div class="col-xs-4">
                              <div class="input-group plusminuswrap">
                                ...
                                <input data-stklimit="<?=$wh['quantity']?>" type="text" id="quantity_<?=$pid?>_<?=$wh['id']?>" name="whqty[<?=$pid?>][]" class="form-control input-number numonly quantity"  value="<?=($curQty>0)?$curQty:'0'?>" min="0" max="<?=$wh['quantity']?>">
                                <span class="input-group-btn">
                        ...
                        <div class="col-xs-4">
                            <div class="input-group">
                                <input type="text" class="form-control datetimepicker-wh delivery-date" value="<?=formatMySQLDate($deliveryDate)?>"  name="delivery_date[<?=$pid?>][]" id="date_<?=$wh['name']?>_<?=$pid?>" placeholder="Delivery Date" r equired="">
                                                                        ...
                                                                        <!-- edit mode -->
                                                                            ...
                                                                            <div class="toClone" data-order_detail_id="<?=$order_detail_id?>">
                                                                                    ...
                                                                                    <div class="col-lg-1 col-md-1 col-sm-1  col-xs-2">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-sm-12 col-xs-12">
                                                                                                <div class="form-group">
                                                                                                    <input type="text"  min="0.00" step="any" class="numonly calc c-discount form-control discnt_ discountRate" id_="discnt"  placeholder="Discount%" value="<?php echo $discountrate; ?>" name="discnt[]" >
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-lg-1 col-md-1 col-sm-1  col-xs-2">
                                    													...
                                    													<div class="form-group">
                                    													    <?php
                                    													        $discountAmount = ($itdtot*$discountrate)/100;
                                    													    ?>
                                    														<input type="text" step="any"   class="numonly calc c-discount-amount form-control discnt_ discountAmount" value="<?=number_format($discountAmount,2)  ?>"    placeholder="Discount Taka" name="discntamnt[]">
                                    													</div>
                                                                                    </div>
