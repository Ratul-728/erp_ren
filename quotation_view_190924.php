    ...
    <tr>
		...
		<td valign="top" align="center">
			...
			<p>
				...
				Sales Associate: <b>
				<?php
				    $salseAssociate = (fetchByID('hr',id,$makeby,'hrName'))?fetchByID('hr',id,$makeby,'hrName'):fetchByID('employee',id,$makeby,'firstname');
				    echo $salseAssociate ;
				?>
				</b>
			</p>
...
if ($resultd->num_rows > 0) {
    ...
    <tr>
      ...
      <td class="number"><?=number_format($totdis, 2, ".", ",")?></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl-items">
  <tbody>
    <tr class="inv-header">
	 ...
	 <?php 
	 $tot=0;$totvat=0;
	 $qrycancel="SELECT c.co_id,i.image,i.barcode,i.name pnm,i.description,i.height,i.heightunit,i.width,i.widthunit,i.length,i.lengthunit,
    ...
    <tr>
      ...
      <td class="number"><?=number_format($rateincvat, 2, ".", ",")?></td>
      <td class="number"><?=number_format(($amt+$itmvat), 2, ".", ",")?></td>
      <td class="number"><?=number_format($discountrate, 2, ".", ",")?></td>
      <td class="number"><?=number_format($disctot, 2, ".", ",")?></td>
    </tr>
<?php }
$amount=$tot+$totvat;
