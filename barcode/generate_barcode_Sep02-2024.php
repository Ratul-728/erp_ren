...
?>
					...
					<td class="box  col-lg-6 col-md-6 col-sm-6"><div class="printit">
                     <?php
						...
						echo "<img alt='".$bc."' src='barcode.php?codetype=Code39&size=40&text=".$bc."&print=true'/>";
...
?>
                            ...
                            <td class="box  col-lg-6 col-md-6 col-sm-6">
<?php 
							    ...
							    echo '<div class="almas">'.$brand.'</div>';
							    echo '<div class="almas">'.$itmcat.'</div>';
							    echo "<img alt='".$bc."' src='barcode.php?codetype=Code39&size=40&text=".$partsbc."&print=true'/>";
							    echo '<div class="price">Tk: '.$mrp.' Including VAT</div>';
							    echo '<div class="price"> length: '.$length.' width: '.$width.' height: '.$height.'</div>';
