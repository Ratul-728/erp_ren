...
else
{
    ...
    */
    $currSection = 'back_order_approval';
                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Approval <i class="fa fa-angle-right"></i> All Back Order</h6>
                       </div>
...
function table_with_filter(url){
    ...
    url = 'phpajax/datagrid_approval.php?action=back';
	table_with_filter(url);	
        ...
        $("#cmbstatus").on("change", function() {
			...
			url = 'phpajax/datagrid_approval.php?action=back&cmbstatus='+status;
