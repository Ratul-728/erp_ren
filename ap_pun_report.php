...
else
{
    ...
    */
    $currSection = 'appreciation_disciplinary_report';
   ...
   if ( isset( $_POST['export'] ) ) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
    			...
    			->setCellValue('E1', 'Total Number of Appreciation')
    			->setCellValue('F1', 'Total Number of Disciplinary');
                  
    			
        $firststyle='A2';
        $qry="SELECT CONCAT(emp.firstname, ' ', emp.lastname) AS empnm, emp.employeecode, h.id,dept.name deptnm, COUNT(CASE WHEN h.type = 2 THEN 1 END) AS punishment_count, 
        ...
        { $i=0;
            ...
            { 
                ...
                $objPHPExcel->setActiveSheetIndex(0)
    					    ...
    					    ->setCellValue($col5, $row["appreciation_count"])
    					    ->setCellValue($col5, $row["punishment_count"]);
    					     
    					    	/* */
    			//$laststyle=$title;	
            }
        }
        $objPHPExcel->getActiveSheet()->setTitle('APPERCIATION_DISCIPLINARY_REPORT');
        $objPHPExcel->setActiveSheetIndex(0);
        $today=date("YmdHis");
        $fileNm="data/".'appreciation_disciplinary_report'.$today.'.xls'; 
    ...
    <div id="wrapper"> 
      ...
      <div class="section">
        ...
        <span>Appreciation & Disciplinary Report</span>
      </div>
                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                        ...
                        <div class="col-sm-3 text-nowrap">
                            <h6>HRM <i class="fa fa-angle-right"></i>Appreciation & Disciplinary Report</h6>
                       </div>
                ...
                <div >
                    ...
                    <table id='listTable' class='display dataTable actionbtn firstcolpad0' width="100%">
                        ...
                        <tr>
                            ...
                            <th>Employee ID </th>
                            <th>Department</th>
                            <th>Total Number of Appreciation</th>
                            <th>Total Number of Disciplinary</th>
                        </tr>
                        </thead>
...
?>
     ...
     <!-- Datatable JS -->       
		...
		url = 'phpajax/datagrid_list_all.php?action=ap_pun_report';
        ...
        $("#month, #year").on("change", function() {
			...
			url = 'phpajax/datagrid_list_all.php?action=ap_pun_report&month='+month+'&year='+year;
