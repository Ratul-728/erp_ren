...
$obj_pdf->SetTitle("Storewise Available Stock Report");
...
<table width="100%" border="0"  cellspacing="0" cellpadding="0">
   <thead>
	<tr>
		...
		<td width="50%" align="right"><h1>Storewise Available Stock Report</h1></td>
	</tr>
	</thead>		
</table>		
...
$obj_pdf->OutPut("Storewise_Available_Stock_Report","I");
//echo $content;
}
?>
