...
else
{
    if ( isset( $_POST['add'] ) ) 
    {
       ...
       $itqry="INSERT INTO `coa`(`glno`, `glnm`, `ctlgl`, `isposted`, `dr_cr`, `lvl`, `opbal`, `closingbal`, `entryby`, `entrydate`, `companyid`) 
                                        VALUES ('".$glacno."','".$glnm."','".$parent_gl."','".$is_posted."','".$type."','".$lvl."','".$opbal."','".$clbal."','".$user."',SYSDATE(),1)";
                         //echo $itqry;die;
    ...
    if ($errflag == 0) {
            ...
            header("Location: ".$hostpath."/coaList.php?res=1&msg=".$err."&mod=7&pg=1");
        
    } else {
         $err="Something went Wrong";
          header("Location: ".$hostpath."/coaList.php?mod=7&res=2&msg=".$err."&id=''");
    }
