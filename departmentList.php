...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/department.php?res=0&msg='Insert Data'&mod=4");
    }
   if ( isset( $_POST['export'] ) ) {
        ...
        $firststyle='A2';
        $qry="SELECT id, `name` FROM `department` WHERE st=1"; 
       // echo  $qry;die;
        ...
        $objPHPExcel->setActiveSheetIndex(0);
        $today=date("YmdHis");
        $fileNm="data/".'department'.$today.'.xls'; 
    ...
    <span class="alertmsg">
                	...
                	<form method="post" action="departmentList.php" id="form1">
                     ...
                     <!-- <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>HRM <i class="fa fa-angle-right"></i>All Department</h6>
                       </div>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
           var table1 = $('#listTable').DataTable({
				...
				"dom": "rtiplf",
                'ajax': {
                    'url':'phpajax/datagrid_list_all.php?action=department'
                },
                'columns': [
                    { data: 'sl' },
                    { data: 'name' },
