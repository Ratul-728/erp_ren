...
else
{
        ...
        else
        {
            ...
            if ($result->num_rows > 0)
            {
                while($row = $result->fetch_assoc()) 
                    { 
                        $uid=$row["id"];$suplierId=$row["suplierId"];
    ...
    {
                        $uid='';$suplierId=''; $Name='';  $address=''; $contact_no='';$email='';$web='';
    $mode=1;//Insert mode
        ...
        <div class="container-fluid pagetop">
            <div class="row">
                <div class="col-lg-12">
                    <p>&nbsp;</p> <p>&nbsp;</p>
                    <p>
                        <form method="post" action="common/addsuplier.php"  id="form1"> <!--onsubmit="javascript:return WebForm_OnSubmit();" -->
                            ...
                            <div class="button-bar">
                                ...
                                <?php } else {?>
                                <input  dat a-to="pagetop" class="btn btn-lg btn-default top" type="submit" name="submit" value="Add Supplier"  id="submit" >
                                <?php } ?>  
