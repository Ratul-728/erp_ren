            ...
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <p>
                     ...
                     <form method="post" action="common/updatecusorderdelivery.php" id="form1" enctype="multipart/form-data">  
                    <!-- START PLACING YOUR CONTENT HERE -->
                 
                    <?php include_once('phpajax/load_order_delivery.php'); ?> 
        <!-- /#end of panel -->    
                     <div class="button-bar">
                        <input  dat a-to="pagetop" class="btn btn-lg btn-default top" type="submit" name="update" value="Deliverd to Agent" id="update" <?php if($orderstatus>6){ ?> disabled <?php }?>  >
