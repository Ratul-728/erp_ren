...
else
{
  ...
  if ( isset( $_POST['export'] ) ) {
        ...
        $firststyle='A7';
        $qry="SELECT p.poid,p.adviceno,DATE_FORMAT(p.orderdt,'%e/%c/%Y') orderdt,DATE_FORMAT(p.delivery_dt,'%e/%c/%Y') received_dt
,t.name cat,i.itemid,pr.name product,i.qty,i.unitprice,i.amount
            ...
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <p>
                     ...
                     <form method="post" action="rpt_chalan_details_itmtp_wise.php" id="form1" enctype="multipart/form-data">  
                    ...
                    <?php include_once('phpajax/rpt_load_chalan_itmtp.php'); ?> 
        <!-- /#end of panel -->    
