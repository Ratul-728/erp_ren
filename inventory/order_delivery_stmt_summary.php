            ...
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <p>
                     ...
                     <form method="post" action="order_delivery_stmt_summary.php?mod=4" id="form1" enctype="multipart/form-data">  
                    <!-- START PLACING YOUR CONTENT HERE -->
                  
                    <?php include_once('phpajax/load_delivery_stmt_summary.php'); ?> 
        <!-- /#end of panel -->    
...
<?php }}?>                    
                       ...
                       <!-- <input  dat a-to="pagetop" class="btn btn-lg btn-default top" type="submit" name="confirm" value="Confirm" id="confirm" <?php if($orderstatus>1){ ?> disabled <?php }?> >-->
