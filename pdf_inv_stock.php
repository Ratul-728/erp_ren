...
$sl = 1;
$loop = "";
    $qry="SELECT s.id,p.id pid,p.code,p.image, s.product,p.name prod,t.name typ,b.title brand, s.freeqty, s.bookqty, s.costprice,p.rate 
...
<table width="100%" border="0"  cellspacing="0" cellpadding="0">
   <thead>
	<tr>
		...
		<td width="50%" align="right"><h1>Stock Report</h1></td>
	</tr>
	</thead>		
</table>		
