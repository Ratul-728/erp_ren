...
if ($usr == '') {
    ...
    $currSection = 'transferdeliveryqa';
    ...
    if($orderID == null){
        ...
        //Get Info
        $qryUpperInfo = "SELECT  ts.tansferdt,  qa.id  FROM `qa` qa LEFT JOIN transfer_stock ts ON ts.id=qa.order_id WHERE ts.toid = '".$orderID."'";
...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper" class="mCustomScrollbar">
        <div class="section">
            ...
            <span>Transfer Stock Orders</span>
        </div>
                        ...
                        <div class="panel-body panel-body-padding">
                            ...
                            <div class="row form-header">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <h6>Sales <i class="fa fa-angle-right"></i> Delivery Transfer Order</h6>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6">
...
<script>
    $(document).ready(function() {
      ...
      $('#find').click(function() {
        ...
        $.ajax({
            url:"phpajax/deliveryTransferQAajax.php",
            method:"POST",
            data:{orderid: order},
            //dataType: 'JSON',
