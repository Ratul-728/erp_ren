...
if ($usr == '') {header("Location: " . $hostpath . "/hr.php");
    ...
    if (isset($_POST['add'])) {
        header("Location: " . $hostpath . "/actiontype.php?res=0&msg='Insert Data'&mod=4");
    }
...
include_once 'menu.php';
    ...
    <span class="alertmsg">
                	...
                	<form method="post" action="actiontypeList.php" id="form1">
                     ...
                     <div class="well list-top-controls">
                      <!--<div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>HRM <i class="fa fa-angle-right"></i>All Action Type</h6>
                       </div>
     ...
     <!-- Datatable JS -->
        ...
        $(document).ready(function(){
            var table1 = $('#listTable').DataTable({
				...
				/*'searching': true,*/
                'ajax': {
                    'url':'phpajax/datagrid_list_all.php?action=actiontype'
                },
                'columns': [
                    { data: 'sl' },
                    { data: 'title' },
