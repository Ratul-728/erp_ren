...

{
...

    {
        ...
        $qry="SELECT a.`id`, a.`hrid`, a.`actiontype`, a.`actiondt`, a.`postingdepartment`, a.`jobarea`, a.`designation`, a.`reportto`, a.`jobtype`, b.Title acttypename, a.effective_to,
                dept.name deptname, ja.Title janame, jt.Title jtname, desi.name desiname, concat(emp.`firstname`, ' ', emp.`lastname`, '( ', emp.`employeecode`, ' )') empname, a.remarks
...

            {
                ...
                while($row = $result->fetch_assoc()) 
                    ...
                    { 
                        ...
                        $deptname = $row["deptname"]; $desiname = $row["desiname"];$empname = $row["empname"]; $remarks = $row["remarks"];
                        ...
                        if($effectiveto != ''){
                            //Convert date
                            $eft_dt = array();
                            $eftpieces = explode("-", $effectiveto);
                            foreach($eftpieces as $val){
                                array_push($eft_dt,$val);
                            }
                            
                            $effective_to = '';
                            $effective_to = $eft_dt[2]."-".$eft_dt[1]."-".$eft_dt[0];
                        }
                            ...
                            <div class="panel panel-info">
                                    ...
                                    <span class="alertmsg"></span>
                                     <div class="row form-header">
    	                                     <div class="col-lg-6 col-md-6 col-sm-6">
          		                                <h6>HRM <i class="fa fa-angle-right"></i> HR Action</h6>
          		                            </div>
      		                            ...
      		                            <div class="col-sm-6">
                                                ...
                                                <p>&nbsp;</p>
                                                    ...
                                                    <ul class="nav nav-tabs">
                                                        <li class="active"><a data-toggle="tab" href="#appreciation">Appreciation</a></li>
                                                        <li><a data-toggle="tab" href="#punishment">Punishment</a></li>
                                                        <li><a data-toggle="tab" href="#posting">Posting</a></li>
                                                      </ul>
                                                    
                                          <div class="tab-content">
                                            <div id="appreciation" class="tab-pane fade in active">
                                                
                                              <h3>Appreciation</h3>
                                            <form method="post" action="common/addhraction.php?type=3"  id="form1" enctype="multipart/form-data">
                                                      ...
                                                      <div class="row">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="form-group styled-select">
                                                                                                ...
                                                                                                <datalist  id="cmbassign1" name = "cmbsupnm1" class="list-cmbassign form-control" >
                                                                                                 ...
                                                                                                 <input type = "hidden" class="empid" name = "empid" id = "empid" value = "<?=$mu ?>">
                                                                                            </div>
                                                          ...
                                                          <div class="col-sm-4">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <input type="text" class="form-control datepicker" id="effective_to" name="effective_to" value="<?php echo $effective_to;?>">
                                                                                        <div class="input-group-addon">
                                                                                            <span class="glyphicon glyphicon-th"></span>
                                                                                        </div>
                                                                                    </div> 
                                                          ...
                                                          <div class="col-sm-12">
                                            	                                    <label for="attachment1">Attachment<span class="redstar">*</span></label>
                                                                                    <div class="input-group">
                                                                                        <label class="input-group-btn">
                                                                                            <span class="btn btn-primary btn-file btn-file">
                                                                                               <i class="fa fa-upload"></i> <input type="file" id="attachment1" name="attachment1[]" style="display: none;" multiple="">
                                                                                            </span>
                                                                                        </label>
                                                          ...
                                                          <div class="col-sm-12">
                                            	                                    <label for="attachment1">Remarks<span class="redstar">*</span></label>
                                                                                    <div class="input-group">
                                                                                       <textarea name="remarks1" class="form-control" id="remarks1" rows="4"></textarea>
                                                                                    </div>
                                                          </div> 
                                                          <div class="col-sm-12">
                                                              <button type="submit" class="btn btn-lg btn-default top" id="add" name="add" value="add">Submit</button>
                                                           </div>
                                            ...
                                            <div id="punishment" class="tab-pane fade">
                                              <h3>Punishment</h3>
                                              <form method="post" action="common/addhraction.php?type=2"  id="form1" enctype="multipart/form-data">
                                            ...
                                            <div id="posting" class="tab-pane fade">
                                              <h3>Posting</h3>
                                                <form method="post" action="common/addhraction.php?type=1"  id="form1" enctype="multipart/form-data">
                                ...
                                ?>
                                    <div class="row">
      		                            ...
      		                            <div class="col-sm-6">
                                                ...
                                                <p>&nbsp;</p>
                                                    ...
                                                    <?php if($type == 3) { ?>
                                                        <li class="active"><a data-toggle="tab" href="#appreciation">Appreciation</a></li>
                                                    <?php } else if($type == 2) { ?>
                                                        <li class="active"><a data-toggle="tab" href="#punishment">Punishment</a></li>
                                                    <?php } else if($type == 1){ ?>
                                            ...
                                            <form method="post" action="common/addhraction.php?type=3"  id="form1" enctype="multipart/form-data">
                                                      ...
                                                      <div class="row">
                                                          ...
                                                          <div class="col-sm-12">
                                            	                                    <label for="attachment1">Remarks<span class="redstar">*</span></label>
                                                                                    <div class="input-group">
                                                                                       <textarea name="remarks1" class="form-control" id="remarks1" rows="4"><?= $remarks ?></textarea>
                                                                                    </div>
                                                          </div> 
                                                          <div class="col-sm-12">
                                                              <button type="submit" class="btn btn-lg btn-default top" id="add" name="update" value="update">Update</button>
                                                           </div>
                                        ...
                                        <?php } else if($type == 2) { ?>
                                            <div id="punishment" class="tab-pane fade  in active">
                                              <h3>Punishment</h3>
                                              <form method="post" action="common/addhraction.php?type=2"  id="form1" enctype="multipart/form-data">
                                                  <input type = "hidden" name = "iid" value = "<?= $_GET["id"] ?>">
                                                  <div class="row">
                                                      ...
                                                      <div class="col-sm-12">
                                                                ...
                                                                <?php
                                                                $qryDoc = "SELECT `filename`, `makedt` FROM `documents` WHERE hraction_id = ".$hrid;
                                                                $resultDoc        = $conn->query($qryDoc);
                                                                while ($rowDoc = $resultDoc->fetch_assoc()) {
                                                                    $docName = $rowDoc["filename"]; $docDate = $rowDoc["makedt"]
                                                                ?>
                                                                <div class="file-link">
                                                                    <div class="fileicon">
                                                                        
                                                                            <a href="./images/upload/documents/<?=$docName;?>" target="_blank"><img src="assets/images/file_icons/doc-file.png" alt=""></a>
                                                                    </div>
                                                                    <strong>Upload Date: <?=formatDate2($docDate)?></strong>
