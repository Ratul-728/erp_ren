        ...
        <div class="ds-divselect-wrapper cat-name">
                <div class="ds-input">
                    ...
                    <input type="hidden" name="cat_id" >
                     <input type="text" name="cat_name" autocomplete="off"  class="input-box form-control" >
                </div>
                <div class="list-wrapper">
                    <div class="ds-list">
                        ...
                        <ul class="input-ul" id="inpUl">
                            ...
                            <li class="pp1" value = "1">Pepsi</li>
                            <li class="pp1" value = "2">CocaCola</li>
                            <li class="pp1" Value = "3">Sprint</li>
                            <li class="pp1" value = "4">Fanta</li>
                        </ul>
                    </div>
                    <div class="ds-add-list">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                 <button class="primary ds-add-list-btn ">Save</button>
                            </div>
                        </div>
