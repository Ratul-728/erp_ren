...
else
{
   ...
   $currSection = 'rpt_profit_loss_fin_detail';
                    ...
                    <div class="col-lg-12">
                            <div class="panel panel-info">
                                <div class="panel-body">
                                    ...
                                    <form method="post" action="rpt_profit_loss__fin_detail.php?pg=1&mod=7" id="form1" enctype="multipart/form-data">  
                                        <!-- START PLACING YOUR CONTENT HERE -->
                                     ...
                                     <?php 
                                            include_once('phpajax/rpt_load_profit_loss_fin_detail.php');
                                            ?> 
                             	 </div>
                            </div>
