        ...
        <div class="container-fluid pagetop">
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <?php include_once('phpajax/load_orderdetail.php'); ?> 
        <!-- /#end of panel -->    
...
<?php }}?>                    
                        ...
                        <input  dat a-to="pagetop" class="btn btn-lg btn-default top" type="submit" name="update" value="Send To Delivery" id="update"  <?php if($orderstatus>3){ ?> disabled <?php }?> >
