...
else
{
   ...
   if ( isset( $_POST['export'] ) ) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
    			...
    			->setCellValue('D1', 'EXPECTED DELIVERY DATE')
                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>QA Gift <i class="fa fa-angle-right"></i> Gift Items </h6>
                       </div>
...
//			}],
    ...
    url = 'phpajax/datagrid_qa.php?action=qagift';
...
//show INVOICE
   ...
   //alert(mylink);
  		...
  		BootstrapDialog.show({
							...
							title: 'GIFT QUOTATION ID #'+$(this).data('socode'),
