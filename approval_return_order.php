...
else
{
    ...
    */
    $currSection = 'approval_return_order';
                	...
                	<form method="post" action="glmasterList.php" id="form1">
                     ...
                     <!-- <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Approval <i class="fa fa-angle-right"></i>Return Order</h6>
                       </div>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
           var table1 = $('#listTable').DataTable({
                ...
                "dom": "rtiplf",
                'ajax': {
                    'url':'phpajax/datagrid_approval.php?action=returnorder'
                },
                'order': [0, 'desc'],
                'columns': [
                    { data: 'sl' },
        ...
        $("#listTable").on("click",".actionbtn", function() {
            ...
            swal({
            title: "Return Order Approval",
            text: "Are you sure you want to proceed with this return order? This action cannot be undone.",
            icon: "info",
            buttons: {
            cancel: {
              text: "Cancel",
...
//show INVOICE
	...
	$(".dataTable").on("click",".show-invoice.btn",function(){
  	...
  	mylink = $(this).attr('href')+"?&qtype=quotation&socode="+$(this).data('socode');
