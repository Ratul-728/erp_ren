                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Delivery  <i class="fa fa-angle-right"></i> Delivery Status <i class="fa fa-angle-right"></i> Order ID: OI-000025 </h6>
                       </div>
                    ...
                    <table id="xxlistTable" class="dataTable actionbtn qadetail-grid" width="100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center noofparts">10</td>
                                
                                <td><!-- QA Status by Warehouse -->
                                    <table width="100%" class="qsw-tbl"  cellpadding="5" cellspacing="5">
                                        <tr>
                                            <td class="qsw-1 qsw-head">Warehouse</td>
                                            <td class="qsw-2 qsw-head qsw-intransit">In transit</td>
                                            <td class="qsw-3 qsw-head qsw-delivered">Delivered</td>
                                            <td class="qsw-4 qsw-head qsw-returned">Returned</td>

                                        </tr>
                                        <tr>
                                            <th class="text-right">Dhanmondi  </th>
                                            <td class="qswr-intransit"><input tabindex="1" type="checkbox" name="1_1"> &nbsp;</td>
                                            <td class="qswr-delivered"><input tabindex="1" type="checkbox" name="1_2"> &nbsp;</td>
                                            <td class="qswr-returned"><input tabindex="1" type="checkbox" name="1_3"> &nbsp;</td>
