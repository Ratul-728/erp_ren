...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/deliveryCO.php?res=0&msg='Insert Data'&mod=3");
    }
                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6> Sales <i class="fa fa-angle-right"></i> CO List </h6>
                       </div>
...
function table_with_filter(url){
    ...
    url = 'phpajax/datagrid_delivery.php?action=deliveryco';
	table_with_filter(url);	
	
//Send to QC
$("#listTable_wrapper").on("click",".sendtoqc", function() {
