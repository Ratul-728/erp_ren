...
else
{
    ...
    */
    $currSection = 'action_payment';
    include_once('common/inc_session_privilege.php');
    $currPage = basename($_SERVER['PHP_SELF']);
    
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/return_payment.php?res=0&msg='Insert Data'&mod=7");
    }
                	...
                	<form method="post" action="#" id="form1">
                     ...
                     <!-- <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Accounting <i class="fa fa-angle-right"></i> All Return Payment Approval</h6>
                       </div>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
           var table1 = $('#listTable').DataTable({
                ...
                "order": [[ 0, "desc" ]],
                'ajax': {
                    'url':'phpajax/datagrid_list_all.php?action=action_payment&filterorg=<?=$filterorg ?>&fdt=<?=$fdt ?>&tdt=<?=$tdt ?>'
                },
                'columns': [
                    { data: 'trdt' },
                    { data: 'customer' },
