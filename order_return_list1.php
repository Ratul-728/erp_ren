             ...
             <span class="alertmsg"></span>   
              ...
              <!-- START PLACING YOUR CONTENT HERE -->
                  <div class="panel panel-info">
          			   <div class="panel-heading"><h1>Returned Orders</h1></div>
        				<div class="panel-body">
							
							
							
                        	<form method="post" action="order_return_list.php?mod=4" id="form1">
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
            $('#listTable').on( 'draw.dt',  function () { putClass(); } )
				...
				scroller: true,
                'ajax': {
                    'url':'phpajax/datagrid_list_all.php?action=orderreturn&lvl=2&fdt=<?php echo $fd1;?>&tdt=<?php echo $td1;?>&dagnt=<?php echo $dagent;?>'
                },
                'columns': [
                    { data: 'order_id' },
                    { data: 'name' },
