...
$qrymenu="select a.id athid,m.menuNm,m.id,m.currSection, a.menu_priv, action_btn from mainMenu m  left join hrAuth a  on a.menuid=m.id and a.hrid=".$mnhrid." WHERE (m.modl = $modid or $modid = 0) and m.activeSt=1";
//echo $qrymenu;die;
                                      	...
                                      	<div class="col-lg-2 col-md-6 col-sm-6">
                                            <div class="form-group d-flex">
                                                    ...
                                                    $isChecked = ($record > 0)?'checked':'';
                                                        ...
                                                        ?>
														<input type="checkbox" <?=$isChecked?>  name="momdule_<?=$tid;?>" data-menuid="<?=$tid;?>" data-privset="<?=substr($keys, 0, -1)?>" value="1" id="momdule_<?=$tid;?>">
														<?php
														    $keys = "";
														?>
