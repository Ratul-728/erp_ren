...
if($action == "do"){
    ...
    if($st == 0){
        $qryUpdate = "UPDATE `approval_do` SET `st`='0', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully declined!";
        }else{
            $msg = "Something went wrong";
        ...
        $qryUpdate = "UPDATE `approval_do` SET `st`='2', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully accepted!";
...
if($action == "qc"){
    ...
    if($st == 0){
        $qryUpdate = "UPDATE `approval_qc` SET `st`='0', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully declined!";
        }else{
            $msg = "Something went wrong";
        ...
        $qryUpdate = "UPDATE `approval_qc` SET `st`='2', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully accepted!";
...
if($action == "withdrawal"){
    ...
    if($st == 0){
        $qryUpdate = "UPDATE `approval_withdrawal` SET `st`='0', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully declined!";
        }else{
            $msg = "Something went wrong";
        ...
        $qryUpdate = "UPDATE `approval_withdrawal` SET `st`='2', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully accepted!";
...
if($action == "future"){
    ...
    if($st == 0){
        $qryUpdate = "UPDATE `invoice` SET `backorder`='2', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully declined!";
        }else{
            $msg = "Something went wrong";
        ...
        $qryUpdate = "UPDATE `invoice` SET `backorder`='1', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully accepted!";
        }else{
            $msg = "Something went wrong";
    ...
    else
    {
        ...
        if($conn->query($qryUpdate) == true)
        {
           ...
           //  $msg= "SELECT ro.ro_id,ro.order_id, q.product_id, ror.return_qty, qaw.warehouse_id
            ...
            $qryInfo = "SELECT ro.ro_id,ro.order_id, q.product_id, ror.return_qty, qaw.warehouse_id
                        FROM `return_order` ro LEFT JOIN return_order_details ror ON ror.ro_id=ro.id LEFT JOIN qa_warehouse qaw ON qaw.id=ror.qaw_id LEFT JOIN qa q ON q.id=qaw.qa_id 
                        WHERE ro.id = ".$id;
...
if($action == "gift"){
    ...
    if($st == 0){
        $qryUpdate = "UPDATE `invoice` SET `approval`='4' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully declined!";
        }else{
            $msg = "Something went wrong";
        ...
        $qryUpdate = "UPDATE `invoice` SET `approval`='0' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully accepted!";
...
if($action == "damage"){
    ...
    if($st == 0){
        $qryUpdate = "UPDATE `approval_damaged` SET `st`='0', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully declined!";
        }else{
            $msg = "Something went wrong";
        ...
        $qryUpdate = "UPDATE `approval_damaged` SET `st`='2', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully accepted!";
        }else{
            $msg = "Something went wrong";
...
if($action == "defect"){
    ...
    if($st == 0){
        $qryUpdate = "UPDATE `approval_defect` SET `st`='0', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully declined!";
        }else{
            $msg = "Something went wrong";
        ...
        $qryUpdate = "UPDATE `approval_defect` SET `st`='2', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $defect_store = 10;
...
if($action == "approval_itm_rate_change"){
    ...
    if($st == 1)
    {
        $qryUpdate = "UPDATE `approval_item_price_change` SET `approvst`='1', approveby = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true)
        {
    ...
    {
        $qryUpdate = "UPDATE `approval_item_price_change` SET `approvst`='2', approveby = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true)
        {
...
if($action == "quotation_price_approval"){
    ...
    if($st == 1)
    {
        $qryUpdate = "UPDATE `approval_quotation_price_change` SET `state`='1', approved_by = '$usr', approvedt = '$date' WHERE id = ".$id; 
        if($conn->query($qryUpdate) == true)
        {
        ...
        $qryUpdate = "UPDATE `approval_quotation_price_change` SET `state`='2', approved_by = '$usr', approvedt = '$date' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true)
        {
           $msg = "Successfully Rejeceted!";
        }
...
if($action == "issue_order"){
    ...
    if($st == 0){
        $qryUpdate = "UPDATE `issue_order` SET `st`='0', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully declined!";
        }else{
            $msg = "Something went wrong";
        ...
        $qryUpdate = "UPDATE `issue_order` SET `st`='2', approved_by = '$usr' WHERE id = ".$id;
        if($conn->query($qryUpdate) == true){
            $msg = "Successfully accepted!";
