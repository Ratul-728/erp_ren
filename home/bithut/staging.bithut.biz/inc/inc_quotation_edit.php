                                                                        ...
                                                                        <!-- edit mode -->
                                                                            ...
                                                                            <div class="toClone" data-order_detail_id="<?=$order_detail_id?>">
                                                                                    ...
                                                                                    <div class="col-lg-1 col-md-1 col-sm-7 col-xs-8">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <?php
                                                                                                //check if it has $isItemPriceApprovalQue;
                                                                                                $conditionArvSt = 'order_id="' .$soid. '" AND item_id=' . $tid;
                                                                                                $approvalSt = fetchByCondition('approval_quotation_price_change', $conditionArvSt, 'state');
                                                                                                //echo $approvalSt; 
                                                                                                 
                                                                                                $conditionQtPriceArv = 'order_id="' . mysqli_real_escape_string($link, $soid) . '" AND item_id=' . intval($tid) . ' AND (state=0 OR state=1)';
                                                                                                $isItemPriceApprovalQue = fetchByCondition('approval_quotation_price_change', $conditionQtPriceArv, 'new_price');
                                                                                                
                                                                                                $salePrice = ($isItemPriceApprovalQue)?$isItemPriceApprovalQue:$itdotc;
                                                                                               // echo $approvalSt; 
                                                                                                
                                                                                                $st0_bg = ($approvalSt == 0)?'priceApprovalQue':'';
                                                                                                $st0_title = ($approvalSt == 0)?'title="Awaiting new price approval"':'';
                                                                                                $st1_title = ($approvalSt == 1)?'title="New price Approved"':'';
                                                                                                
                                                                                                if($approvalSt == 2){
                                                                                                    //fetch cost price from item table, as quotation table holds changed price;
                                                                                                    $salePrice = fetchByID('item','id',$tid,'rate');
                                                                                                }
                                                                                                //echo $salePrice;
                                                                                            ?>
                                                                                            <input  type="text" <?=$st1_title?>  <?=$st0_title?> class="calc editable c-price form-control unitprice_otc1_ unitPriceV2_ <?=$st0_bg?>" placeholder="Price" id_="unitprice_otc1" value="<?=$salePrice?>" name="unitprice_otc[]" readonly>
                                                                                    ...
                                                                                    <label class="hidden-lg">Unit Total</label>
                                                                                        <div class="form-group">
                                                                                            <input type="text" editable class="c-price-utt form-control TotalAmount_ unitTotal" id_="total" placeholder="Unit Total" value="<?php echo $itdtot; ?>" readonly  name="total[]">
