                        ...
                        <tbody>
                          <tr class="venrow" id="prrowid_51" data-prid="51">
                              <td class="product">
                                   ...
                                   <label for="imac"><input type="hidden" name="pid[]" value="51">  iMac</label>
                          ...
                          <tr class="venrow" id="pid5">
                              <td class="product">
                                   ...
                                   <label for="iPhone"><input type="hidden" name="pid[]"  value="5">  iPhone</label>
                          ...
                          <tr class="venrow" id="pid1">
                              <td class="product">
                                   ...
                                   <label for="Laptop"><input type="hidden" name="pid[]"  value="1">  Laptop</label>
