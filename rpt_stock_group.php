...
<div id="wrapper"> 
            ...
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <p>
                     ...
                     <form method="post" action="rpt_stock_group.php?mod=6" id="form1" enctype="multipart/form-data">  
    ...
    <?php 
    $qry1="SELECT `id`, `name`  FROM `itemgroup` order by name";  $result1 = $conn->query($qry1);   if ($result1->num_rows > 0) { while($row1 = $result1->fetch_assoc())
    { 
