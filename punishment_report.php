...
else
{
   ...
   if ( isset( $_POST['export'] ) ) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('E1', 'Type of disciplinary action')
    			->setCellValue('F1', 'Date Issued')
    			->setCellValue('G1', 'Date Expired');
        ...
        { $i=0;
            ...
            { 
                ...
                $objPHPExcel->setActiveSheetIndex(0)
    					    ...
    					    ->setCellValue($col7, $row["effective_to"]);
    					     
    					    	/* */
    			//$laststyle=$title;	
            }
        }
        $objPHPExcel->getActiveSheet()->setTitle('DISCIPLINARY_REPORT');
        $objPHPExcel->setActiveSheetIndex(0);
        $today=date("YmdHis");
        $fileNm="data/".'disciplinary_report'.$today.'.xls'; 
                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                        ...
                        <div class="col-sm-3 text-nowrap">
                            <h6>HRM <i class="fa fa-angle-right"></i>Disciplinary Report</h6>
                       </div>
...
?>
     ...
     <!-- Datatable JS -->       
		...
		url = 'phpajax/datagrid_list_all.php?action=disciplinary_report';
        ...
        $("#month, #year").on("change", function() {
			...
			url = 'phpajax/datagrid_list_all.php?action=disciplinary_report&month='+month+'&year='+year;
