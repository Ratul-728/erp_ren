...
if ($usr == '') {header("Location: " . $hostpath . "/hr.php");
    ...
    if($fdt == '') $fdt = date("Y-m-d");
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('E1', 'Debit Amount')
            ->setCellValue('F1', 'Credit Amount')
            ->setCellValue('G1', 'p');
        ...
        if ($result->num_rows > 0) {$i = 0;
            while ($row = $result->fetch_assoc()) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue($col5, $row['Debit_amt'])
                    ->setCellValue($col6, $row["credit_amt"])
                    ->setCellValue($col7, $row["p"]);
        ...
        $objPHPExcel->setActiveSheetIndex(0);
        $today     = date("YmdHis");
        $fileNm    = "data/" . 'profit_loss_report' . $today . '.xls';
    ...
    <span class="alertmsg">
                    ...
                    <!--  <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Accounting <i class="fa fa-angle-right"></i>Profit Loss Report</h6>
                       </div>
...
include_once 'common_footer.php';
        ...
        function table_with_filter(url){
             ...
             var table1 = $('#listTable').DataTable({
                ...
                footerCallback: function (row, data, start, end, display) {
                    ...
                    var columnsToTotal = [4, 5]; // Indexes of the columns to total
	...
	url = 'phpajax/datagrid_list_all.php?action=rpt_profit_loss&fdt=<?php echo $fdt; ?>';
	table_with_filter(url);	
        ...
        $('#filter_date_from').daterangepicker({
          ...
          console.log("New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')");
        	...
        	if(start<end){
        	url = 'phpajax/datagrid_list_all.php?action=rpt_profit_loss&fvouch=<?= $fvouch; ?>&fdt='+start.format('DD/MM/YYYY')+'&tdt='+end.format('DD/MM/YYYY');
        	$('#from_dt').val(start.format('YYYY-MM-DD'));
        	$('#to_dt').val(end.format('YYYY-MM-DD'));
        	}
        	else
        	{
        	url = 'phpajax/datagrid_list_all.php?action=rpt_profit_loss&fvouch=<?= $fvouch; ?>&fdt='+end.format('DD/MM/YYYY')+'&tdt='+start.format('DD/MM/YYYY');
		...
		//convert pdf trigger;
			...
			$("#exportpdf").on("click",function(){
				...
				var pdfurl = 'pdf_inc_exp.php?dt_f='+sdt+'&dt_t='+edt;
