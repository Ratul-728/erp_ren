...
// SELECT FORMAT(`dueamount`, 2) AS formatted_amount, FORMAT(`invoiceamt`, 2) AS formatted_invoiceamt FROM `invoice` WHERE `invoiceno` = '".$_REQUEST['invoiceno']."'";
	...
	<section class="tabs-content">
		...
		<div id="tab1">
				...
				<div class="row">
					...
					<!--Bank -->
					<div class="col-xs-6 ischeck photowrap">
