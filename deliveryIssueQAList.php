...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/deliveryIssueQA.php?res=0&msg='Insert Data'&mod=3");
    }
...
//			}],
    ...
    url = 'phpajax/datagrid_delivery.php?action=deliveryissueqa';
