...
else
{
  ...
  if ( isset( $_POST['export'] ) ) 
  {
    ...
    $currSection = 'rpt_balance_sheet_fin';
            ...
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <p>
                     ...
                     <form method="post" action="rpt_balance_sheet.php?pg=1&mod=17" id="form1" enctype="multipart/form-data">  
...
<?php } ?>                    
                            ...
                            <?php include_once('phpajax/rpt_load_balance_sheet_fin.php'); ?> 
        <!-- /#end of panel -->
                    </form>
