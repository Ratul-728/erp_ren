...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/hrcompansation.php?res=0&msg='Insert Data'&mod=4");
    }
   if ( isset( $_POST['export'] ) ) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('C1', 'COMPANSATION');
                  
    			
        $firststyle='A2';
        $qry="SELECT a.`id`, concat(emp.firstname, ' ', emp.lastname) empname, c.title com
        ...
        { $i=0;
            ...
            { 
                ...
                $objPHPExcel->setActiveSheetIndex(0)
    						...
    						->setCellValue($col3, $row['com']);
    					    
    					    	/* */
    			//$laststyle=$title;	
            }
        }
        $objPHPExcel->getActiveSheet()->setTitle('HR COMPANSATION');
        $objPHPExcel->setActiveSheetIndex(0);
        $today=date("YmdHis");
        $fileNm="data/".'hr_compansation'.$today.'.xls'; 
    ...
    <span class="alertmsg">
                	...
                	<form method="post" action="hrcompansationList.php" id="form1">
                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                         ...
                         <div class="col-sm-3 text-nowrap">
                            <h6>HRM <i class="fa fa-angle-right"></i> Payroll <i class="fa fa-angle-right"></i>All HR Compansation</h6>
                       </div>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
            var table1 = $('#listTable').DataTable({
				...
				/*'searching': true,*/
                'ajax': {
                    'url':'phpajax/datagrid_list_all.php?action=hrcompansation'
                },
                'columns': [
                    { data: 'sl'},
                    { data: 'empname' },
