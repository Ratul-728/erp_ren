                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="order_id" id="order_id" value="<?= $orderID ?>" disabled  >
...
/*													  bottom: 23px;*/
	...
	<?php
        ...
        $itmdtqry    = "SELECT i.name productnm,i.id productid, qaw.ordered_qty, b.name warehouse, qaw.`pass_qty`, qaw.id FROM `qa_warehouse` qaw LEFT JOIN branch b ON qaw.warehouse_id = b.id 
                        LEFT JOIN qa qa ON qa.id = qaw.qa_id LEFT JOIN item i ON i.id = qa.product_id WHERE qaw.pass_qty > 0 AND qaw.qa_id = ".$qaId;
        //echo $itmdtqry;die;
                                            ...
                                            <div class="toClone">
												...
												<div class="col-lg-2 col-md-1 col-sm-1 col-xs-4">
													<div class="form-group">
														<input type="text" class="form-control" name="deliverableQty[]" id="deliverableQty[]" value="" >
                                                    </div>
												</div>
        ...
        <!-- /#end of panel -->
          ...
          <!-- START PLACING YOUR CONTENT HERE -->
                    ...
                    <?php } else if ($mode == 1){ ?>
                        <form method="post" action="deliveryQA.php?mod=3"  id="form1">     
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-6">
    	                                    <label for="po_dt">Order ID</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="cmbempnm" id="cmbempnm" value=""  >
