...

{
   ...
   if ($res==1)
    ...
    $qry="SELECT `id`, `socode`,`srctype`, `customer`, `orderdate`, `deliverydt`, `deliveryby`, `accmanager`, `vat`, `tax`, `invoiceamount`, `makeby`, `makedt` FROM `soproduct`where  id= ".$id; 
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <p>
                       ...
                       <form method="post" action="common/addsoproduct.php" id="form1" enctype="multipart/form-data">  
...
<?php if($mode==1){?> 	                                        
    ...
    <?php $qryitm="SELECT `id`,concat(`modelCode`,'-', `productName`) name FROM `product`"; $resultitm = $conn->query($qryitm); if ($resultitm->num_rows > 0) {while($rowitm = $resultitm->fetch_assoc()) 
...
<?php } else {
$itdgt=0;    
$itmdtqry="SELECT `id`, `socode`, `sosl`, `productid`, `mu`, `qty`, `otc`, `mrc`, `remarks`, `makeby`, `makedt` FROM `soproddetails` WHERE `socode`='".$soid."'";
$resultitmdt = $conn->query($itmdtqry); if ($resultitmdt->num_rows > 0) {while($rowitmdt = $resultitmdt->fetch_assoc()) 
              { 
                  $itmdtid= $rowitmdt["productid"];  $itdmu=$rowitmdt["mu"]; $itdqu=$rowitmdt["qty"]; $itdotc=$rowitmdt["otc"]; $itdmrc=$rowitmdt["mrc"]; $itdrem=$rowitmdt["remarks"];
                  $itdtot=($itdqu*$itdotc)+($itdqu*$itdmrc); $itdgt=$itdgt+$itdtot;
?>                                            
    ...
    <?php $qryitm="SELECT `id`,`modelCode` name FROM `product` where `id`=".$itmdtid.""; $resultitm = $conn->query($qryitm); if ($resultitm->num_rows > 0) {while($rowitm = $resultitm->fetch_assoc()) 
 ...
 <?php $qrymu="SELECT `id`, `name`, `description`, `st` FROM `mu` WHERE st=1 and `id`=".$itdmu.""; $resultmu = $conn->query($qrymu); if ($resultmu->num_rows > 0) {while($rowmu = $resultmu->fetch_assoc()) 
    ...
    ?>                                                          
     ...
     <?php  }}?>                                                       
                                                ...
                                                <div class="row qtnrows">
                                                    <div class="col-sm-6 col-xs-6">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control quantity" id="quantity" value="<?php echo $itdqu;?>" name="quantity[]">
                                                      </div>
                                                  </div>
                                                    <div class="col-sm-6 col-xs-6">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control unitPrice" id="unitpriceotc" value="<?php echo $itdotc;?>" name="unitpriceotc[]">
                                                      </div>
                                                  </div>
                                                  </div>
                                              </div>
                                                ...
                                                <div class="row qtnrows">
                                                    <div class="col-sm-6 col-xs-6">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control unitPrice" id="unitpricemrc" value="<?php echo $itdmrc;?>" name="unitpricemrc[]">
                                                      </div>
                                                  </div>
                                                    <div class="col-sm-6 col-xs-6">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control unitTotalAmount" id="unittotal"  value="<?php echo $itdtot;?>" name="unittotal[]">
                                                      </div>
                                                  </div>
                                                  </div>
                                              </div>
                ...
                <input type="text" class="form-control" id="grandTotal" value="<?php echo $itdgt;?>" disabled>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="cmbitmcat">Devery By</label>
...
<?php  }}?>                                                       
        ...
        <!-- /#end of panel -->      
                    ...
                    <div class="button-bar">
                          ...
                          <?php } ?>
                        <a href = "http://bithut.biz/BitFlow/soproductList.php?pg=1&mod=1">
