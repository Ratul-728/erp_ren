                         ...
                         <div class="well list-top-controls">
                                  <div class="row border">
                                        ...
                                        <div class="col-sm-3  text-nowrap">
                                                <h6>Sales <i class="fa fa-angle-right"></i>Cancel Order</h6>
...
$(document).ready(function(){
           ...
           var table1 = $('#listTable').DataTable({
			   ...
			   "order": [[ 0, "desc" ]],
                ...
                'columns': [
                    ...
                    { data: 'qty_canceled', "orderable": false },
	...
	url = 'phpajax/datagrid_list_all.php?action=cancelorder&filterorg=<?=$filterorg ?>&filterst=<?=$filterst ?>&fdt=<?=$fdt ?>&tdt=<?=$tdt ?>&yeardt=<?=$yeardt ?>';
	...
	table_with_filter(url);		
        ...
        $("#filterst, .dl-itemName").on("change", function() {
			...
			url = 'phpajax/datagrid_list_all.php?action=cancelorder&customer='+dataValue+'&filterst='+status;
    ...
    $(document).on("change", ".dl-cmborg", function() {
        ...
        var filterorg = id;
			...
			url = 'phpajax/datagrid_list_all.php?action=cancelorder&filterorg='+filterorg;
            setTimeout(function(){
				table_with_filter(url);
