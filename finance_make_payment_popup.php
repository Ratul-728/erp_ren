...
$walletmnt = fetchByID('organization',id,$_REQUEST['cid'],'balance') + fetchByID('organization',id,$_REQUEST['cid'],'reserve_balance');
...
$qryDue    = "SELECT  FORMAT(COALESCE(`dueamount`,0) + COALESCE(`due_reservedamt`,0), 2) AS formatted_amount, FORMAT(COALESCE(`invoiceamt`,0) + COALESCE(`reserved_amount`,0), 2) AS formatted_invoiceamt  FROM `invoice` WHERE `invoiceno` = '".$_REQUEST['invoiceno']."'";
					...
					<div class="col-sm-12">
						<div class="form-group">
							...
							<div class="form-group styled-select">
								...
								//	fetchComboHTML('paywith','paywith','form-control','transmode','name','id','');
							//	fetchComboHTMLwidthCondition('paywith','paywith','form-control','transmode','name','id','1','','id=1')
					  //fetchComboHTMLwidthCondition($cmbname,$cmbid,$cmbclass,$table,$name,$id,$selected,$defaultOptionTxt,$condition)
					                fetchComboHTMLv2withcondition('paywith','paywith','form-control','transmode','name','id','',' Paid With',' id=1');
								?>
