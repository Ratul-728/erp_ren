...
if ($usr == '') {
 ...
 //echo $qry; die;
    ...
    $currSection = 'financialcustomization';
...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper" class="mCustomScrollbar">
        <div class="section">
            ...
            <span>Financial Customization</span>
        </div>
        ...
        <div class="container-fluid pagetop">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p>
                        <form method="post" action="common/addfinancialCustomization.php" id="form1" enctype="multipart/form-data">
                            ...
                            <span class="alertmsg"></span>
                                   ...
                                   <div class="row form-header">
	                                     ...
	                                     <div class="col-lg-6 col-md-6 col-sm-6">
      		                                <h4>Account <i class="fa fa-angle-right"></i> Financial Customization </h4>
      		                            </div>
            ...
            ?>
                                            ...
                                            <div class="toClone">
												...
												<div class="col-lg-1 col-md-1 col-sm-7 col-xs-8">
													...
													<div class="form-group">
														<input  type="text" class="c-price form-control qty" placeholder="Quantity" id_="qty[]" value="<?=$qty?>" name="qty[]" readonly>
													</div>
												</div>												
                                                ...
                                                <div class="col-lg-2 col-md-1 col-sm-2 col-xs-5">
                                                 ...
                                                 <div class="col-lg-1 col-md-1 col-sm-2 col-xs-5">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control adjustment" id_="adjustment" placeholder="Reserved(%)" value="<?= $adjustment ?>"  name="adjustment[]">
...
<?php }} ?>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <a href = "./financialCustomizationList.php?pg=1&mod=17">
