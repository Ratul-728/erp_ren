    ...
    <div id="page-content-wrapper">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="saletype" id="saletype" class="form-control saletype" planceholder="Select Sales Type" Required>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6" id="projdiv" style="display: none;"> 
                                        <div class="form-group">
                                            ...
                                            <div class="ds-input">
                                                ...
                                                <input type="text" name="desig_name" id="proj"  autocomplete="off" placeholder="Select Project"  class="input-box4 form-control" value = "<?= $proj ?>" required>
                                            </div>
        ...
        <?php if($mode == 1) { //insert ?>
            ...
            <?php 
        			...
        			$qryitm = "SELECT i.id, i.image, i.name,i.code, round(i.vat, 2) vat, round(i.ait, 2) ait, round(i.rate, 2) rate, round(i.cost, 2) cost , (COALESCE(s.freeqty,0) + COALESCE(s.futureqty,0) + COALESCE(s.backorderqty,0)) freeqty
        						FROM item i
        ...
        /*													  bottom: 23px;*/
            ...
            <?php 
        					...
        					$qryitm = 	"SELECT i.id, i.name,i.code, round(i.vat, 2) vat, round(i.ait, 2) ait, round(i.rate, 2) rate, round(i.cost, 2) cost , (COALESCE(s.freeqty,0) + COALESCE(s.futureqty,0) + COALESCE(s.backorderqty,0)) freeqty
        						FROM item i
...
$(document).on("change", ".productname2", function() 
{
