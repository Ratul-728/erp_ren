...
else
{
    ...
    */
    $currSection = 'approval_check';
    include_once('common/inc_session_privilege.php');
    $currPage = basename($_SERVER['PHP_SELF']);
    
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/approval_check.php?res=0&msg='Insert Data'&mod=7");
    }
                	...
                	<form method="post" action="#" id="form1">
                     ...
                     <!-- <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Approval <i class="fa fa-angle-right"></i>Cheque Approval</h6>
                       </div>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
           var table1 = $('#listTable').DataTable({
                ...
                "dom": "rtiplf",
                'ajax': {
                    'url':'phpajax/datagrid_approval.php?action=check'
                },
                'order': [0, 'desc'],
                'columns': [
                    { data: 'sl' },
                    { data: 'quotation', "orderable": false },
                    { data: 'invoice', "orderable": false },
                    { data: 'checkno', "orderable": false },
                    { data: 'image', "orderable": false },
                    { data: 'checkdt', "orderable": false },
        ...
        $("#listTable").on("click",".actionbtn", function() {
            ...
            text: "Are you sure you want to proceed with this cheque approval? This action cannot be undone.",
            icon: "info",
            buttons: {
            cancel: {
              text: "Cancel",
...
<script>
$(document).ready(function(){
  $("#listTable_wrapper").after(function() {
    $(this).find('table').wrap('<div class="dataTables_scroll"></div>');
  });
});
</script>
