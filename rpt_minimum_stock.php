...
if ($usr == '') {header("Location: " . $hostpath . "/hr.php");
    ...
    if (isset($_POST['add'])) {$prv = $_GET['up'];
        ...
        header("Location: " . $hostpath . "/product.php?res=0&msg='Insert Data'&mod=1&up=" . $prv);
    ...
    if (isset($_POST['export'])) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('E4', 'MINIMUM QUANTITY')

            ->setCellValue('F4', 'FREE QUANTITY')

            ->setCellValue('G6', 'COST PRICE')
            ...
            while ($row = $result->fetch_assoc()) {
               ...
               # $col8 = 'I' . $urut;
                ...
                $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue($col5, $row['minimumstock'])
        ...
        $objPHPExcel->getActiveSheet()->setTitle('MINIMUM STOCK REPORT');

        $objPHPExcel->setActiveSheetIndex(0);

        $today     = date("YmdHis");

        $fileNm    = "data/" . 'min_stock_report' . $today . '.xls';
...
include_once 'menu.php';
    ...
    <span class="alertmsg">
                	...
                	<form method="post" action="rpt_minimum_stock.php?mod=12" id="form1">
                     ...
                     <div class="well list-top-controls">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Invenctory <i class="fa fa-angle-right"></i> Minimum Stock Inventory</h6>
                       </div>
...
function table_with_filter(url){
	...
	url = 'phpajax/datagrid_list_all.php?action=min_stock';
	table_with_filter(url);	
		...
		//convert pdf trigger;
			...
			$("#exportpdf").on("click",function(){
				...
				var pdfurl = "pdf_minimum_stock.php";
