...
if ($usr == '') {header("Location: " . $hostpath . "/hr.php");
     ...
     */
    $currSection = 'returnorder';
    $currPage    = basename($_SERVER['PHP_SELF']);
	// load session privilege;
	include_once('common/inc_session_privilege.php');
    if (isset($_POST['add'])) {
        header("Location: " . $hostpath . "/returnorder.php?res=0&msg='Insert Data'&mod=3");
    }
 ...
 <!--end inv Modal view-->
  ...
  window.closeModal = function(){
    $('#invpay-modal').modal('hide');
     ...
     <!-- Datatable JS -->
		<script src="js/plugins/datagrid/datatables.min.js"></script>z
...
$(document).ready(function(){
           ...
           var table1 = $('#listTable').DataTable({
			   ...
			   "order": [[ 0, "desc" ]],
                ...
                'columns': [
                    ...
                    { data: 'qcstatus', "orderable": false },
                    { data: 'delistatus', "orderable": false },
	...
	url = 'phpajax/datagrid_list_all.php?action=returnorder&filterorg=<?=$filterorg ?>&filterst=<?=$filterst ?>&fdt=<?=$fdt ?>&tdt=<?=$tdt ?>&yeardt=<?=$yeardt ?>';
	...
	table_with_filter(url);		
        ...
        $("#filterst, .dl-itemName").on("change", function() {
			...
			url = 'phpajax/datagrid_list_all.php?action=returnorder&customer='+dataValue+'&filterst='+status;
    ...
    $(document).on("change", ".dl-cmborg", function() {
        ...
        var filterorg = id;
			...
			url = 'phpajax/datagrid_list_all.php?action=returnorder&filterorg='+filterorg;
            setTimeout(function(){
				table_with_filter(url);
...
$('#filter_date_from').daterangepicker({
  ...
  console.log("New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')");
	...
	if(start<end){
	url = 'phpajax/datagrid_list_all.php?action=returnorder&dt_f='+start.format('YYYY-MM-DD')+'&dt_t='+end.format('YYYY-MM-DD');
	}
	else
	{
	url = 'phpajax/datagrid_list_all.php?action=returnorder&dt_f='+end.format('YYYY-MM-DD')+'&dt_t='+start.format('YYYY-MM-DD');
	}
	//alert(url);
	//setTimeout(function(){
		table_with_filter(url);
...
$(".cancelBtn").click(function(){
	...
	url = 'phpajax/datagrid_list_all.php?action=returnorder';
	table_with_filter(url);
});
