...
<?php if ($mode == 1 || $mode == 5) { //insert ?>
    ...
    <?php 
        ...
        $resultitm        = $conn->query($qryitm);if ($resultitm->num_rows > 0) {while ($rowitm = $resultitm->fetch_assoc()) {
            ...
            ?>
                                                                <option  data-value="<?php echo $tid; ?>" data-stock="<?=$stock?>" data-prdcost="<?php echo $prdcost; ?>" data-up="<?php echo $up; ?>" data-cost="<?php echo $cost; ?>" data-vat="<?php echo $vat; ?>" data-ait="<?php echo $ait; ?>" value="<?php echo $nm; ?>  (St: <?=$stock?>)"><?php echo $nm; ?> (St: <?=$stock?>)</option>
    <?php }} ?>
                                                            </datalist>
                                                        </div>
                                                    </div>
...
<?php }} ?>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="details" name="details" rows="2" required><?php echo $details; ?></textarea>
