                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Quality <i class="fa fa-angle-right"></i> Transfer Stock</h6>
                       </div>
...
//			}],
    ...
    url = 'phpajax/datagrid_qa.php?action=qatransfer';
	table_with_filter(url);	
        ...
        $("#cmbstatus, .dl-itemName").on("change", function() {
			...
			url = 'phpajax/datagrid_qa.php?action=qatransfer&customer='+dataValue+'&cmbstatus='+status;
