...
else
{
    ...
    */
    $currSection = 'rpt_damaged_product';
   ...
   if ( isset( $_POST['export'] ) ) {
       ...
       // echo  $qry;die;
        ...
        { $i=0;
            ...
            { 
                ...
                $objPHPExcel->setActiveSheetIndex(0)
    			            ...
    			            ->setCellValue($col12, $row['damaged_qty'])
        ...
        $objPHPExcel->setActiveSheetIndex(0);
        $today=date("YmdHis");
        $fileNm="data/".'damaged_product_report_'.$today.'.xls'; 
                	...
                	<form method="post" action="#" id="form1">
                     ...
                     <!-- <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Report <i class="fa fa-angle-right"></i>All Damaged Product</h6>
                       </div>
                        ...
                        <div class="pull-right grid-panel form-inline">
                            ...
                            <input type="hidden" name="to_dt" id = "to_dt">
                             ...
                             <div class="form-group">
                                <input type="text" class="form-control orderdtpicker datepicker_history_filterx" autocomplete="off" placeholder="Damaged Date Range" name="filter_date_from" id="filter_date_from"  value="" >
                            </div> 
                            <div class="form-group">
							...
							<div class="form-group">
                            <input type="hidden" id="pdfsource" url="pdf_damaged_product.php">
...
?>
            ...
            function table_with_filter(url){
             ...
             var table1 = $('#listTable').DataTable({
				...
				'columns': [
                    ...
                    { data: 'damaged_qty', "orderable": false},
                    { data: 'damaged_image', "orderable": false },
	...
	url = 'phpajax/datagrid_qa.php?action=damaged_rpt';
	table_with_filter(url);	
        ...
        $('#filter_date_from').daterangepicker({
          ...
          console.log("New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')");
        	...
        	if(start<end){
        	url = 'phpajax/datagrid_qa.php?action=damaged_rpt&dt_f='+start.format('YYYY-MM-DD')+'&dt_t='+end.format('YYYY-MM-DD');
        	$('#from_dt').val(start.format('YYYY-MM-DD'));
        	$('#to_dt').val(end.format('YYYY-MM-DD'));
        	}
        	else
        	{
        	url = 'phpajax/datagrid_qa.php?action=damaged_rpt&dt_f='+end.format('YYYY-MM-DD')+'&dt_t='+start.format('YYYY-MM-DD');
