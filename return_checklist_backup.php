...
.product_checklist td, .tbl-orderinfo td{
   padding: 10px; 
}	
</style>	
</head>
...
<table width="100%" border="1" cellspacing="0" cellpadding="5" class="product_detail">
  <tbody>
    <tr class="inv-header">
      <th>PRODUCT NAME</th>
...
<h5>PRODUCT CHECKLIST REPORT [QA TEAM]  </h5> 
<h5 style="margin-bottom:0px!important;">PRODUCT LIST </h5> 
<table width="100%" border="1" cellspacing="0" cellpadding="10"  class="product_checklist">
  <tbody>
    <tr class="inv-header" style="display:none;">
      <th>PRODUCT NAME</th>
      <th>BARCODE</th>
      <th>DETAILS</th>
      <th>QUANTITY</th>
    ...
    <tr>
      ...
      <td>1 Damaged</td>
      <td>
         <img src="assets/images/products/300_300/00000334.jpeg" width="50" height="50">
      </td>
...
<div class="checklist">
    <table border="0" cellpadding="5" cellspacing="2">
        <tr>
            ...
            CHECKLIST FOR LOGISTIC TEAM FOR RETURNING PRODUCT:<br>
    ...
    <div>
		<div class="icheck-primary privwrap">
			...
			<label for="product_takento">TANEN TO   <input type="text" name="warehouse" size="10">   &nbsp; WAREHOUSE</label>
		</div>
    </div>
    </td>
    </tr>
