...
include_once 'menu.php';
    ...
    <span class="alertmsg">
                	...
                	<form method="post" action="approved_quotationList.php" id="form1">
                     ...
                     <div class="well list-top-controls">
                      <!--<div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Procurement <i class="fa fa-angle-right"></i>All Approved Quotation</h6>
                       </div>
     ...
     <!-- Datatable JS -->
        ...
        $(document).ready(function(){
            var table1 = $('#listTable').DataTable({
				...
				/*'searching': true,*/
                'ajax': {
                    'url':'phpajax/datagrid_list_all.php?action=approved_quotation'
                },
                'columns': [
                    { data: 'sl' },
                    { data: 'quotation' },
