...
if ($usr == '') {header("Location: " . $hostpath . "/hr.php");
     ...
     */
    $currSection = 'periodic_qc';
    $currPage    = basename($_SERVER['PHP_SELF']);

    if (isset($_POST['add'])) {
        header("Location: " . $hostpath . "/issue_warehouse.php?res=0&msg='Insert Data'&mod=12");
    }
                     ...
                     <div class="well list-top-controls">
                      <!--<div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Inventory <i class="fa fa-angle-right"></i> Periodic QC</h6>
                       </div>
     ...
     <!-- Datatable JS -->
        ...
        $(document).ready(function(){
            var table1 = $('#listTable').DataTable({
				...
				/*'searching': true,*/
                'ajax': {
                    'url':'phpajax/datagrid_list_all.php?action=periodic_qc'
                },
                'columns': [
                    { data: 'id','bVisible': false },
                    { data: 'photo', 'orderable':false},
                    { data: 'prodnm', 'orderable':false},						
                    { data: 'barcode', 'orderable':false },
                    { data: 'warehouse', 'orderable':false},						
                    { data: 'freeqty', 'orderable':false },
					{ data: 'qadt', 'orderable':false},
