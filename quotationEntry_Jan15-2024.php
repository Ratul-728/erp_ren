    ...
    <div id="page-content-wrapper">
                        ...
                        <!-- START PLACING YOUR CONTENT HERE -->
                            ...
                            <!-- <br> -->
                          	<!-- <p>(Field Marked * are required) </p> -->
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6" id="projdiv" style="display: none;"> 
                                        <div class="form-group">
        ...
        <?php if($mode == 1) { //insert ?>
            ...
            <?php 
        			...
        			$qryitm = "SELECT i.id, i.name,i.code, round(i.vat, 2) vat, round(i.ait, 2) ait, round(i.rate, 2) rate, round(i.cost, 2) cost , COALESCE(s.freeqty,0)freeqty
        						FROM item i
