...
else
{
   ...
   if ( isset( $_POST['export'] ) ) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
    			...
    			->setCellValue('E1', 'DELIVERY DATE')
                ->setCellValue('F1', 'DELIVERY START TIME')
                ->setCellValue('G1', 'DELIVERY END TIME')
                ->setCellValue('H1', 'SUPERVISOR')
...
//WHERE  s.`status`<>6 order by s.`socode` asc"; 
       ...
       // echo  $qry;die;
        ...
        $objPHPExcel->setActiveSheetIndex(0);
        $today=date("YmdHis");
        $fileNm="data/".'PENDING_DELIVERY_'.$today.'.xls'; 
    ...
    <?php
$qry1    = "select id,name from deliverystatus order by id";
...
//			}],
    ...
    url = 'phpajax/datagrid_scm.php?action=pendingdelivery';
	table_with_filter(url);	
        ...
        $("#cmbstatus").on("change", function() {
			...
			url = 'phpajax/datagrid_scm.php?action=pendingdelivery&cmbstatus='+status;
