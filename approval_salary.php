                ...
                <div >
                    ...
                    <table id='listTable' class='display dataTable' width="100%">
                        ...
                        <tr>
                            ...
                            <th>Month</th>
                            <th>Year</th>
                            <th>1st Persion Action</th>
                            <th>Action Date</th>
                            <th>Action Type</th>
                            <th>2st Persion Action</th>
                            <th>Action Date</th>
                            <th>Action Type</th>
                            <th>Action</th>
                        </tr>
        ...
        $(document).ready(function(){
           var table1 = $('#listTable').DataTable({
                ...
                'columns': [
                    ...
                    { data: 'firstaction', "orderable": false },
                    { data: 'empnm2', "orderable": false },
                    { data: 'approved_date2', "orderable": false },
                    { data: 'secondaction', "orderable": false },
