                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6> SCM <i class="fa fa-angle-right"></i>Transfer Order Delivery Status </h6>
                       </div>
...
//			}],
    ...
    url = 'phpajax/datagrid_scm.php?action=transferdeliverystatus';
...
//show INVOICE
	...
	$(".dataTable").on("click",".show-invoice.btn",function(){
  	...
  	mylink = $(this).attr('href')+"?doid="+$(this).data('doid');
