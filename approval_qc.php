                	...
                	<form method="post" action="glmasterList.php" id="form1">
                     ...
                     <!-- <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Approval <i class="fa fa-angle-right"></i>All QC Request</h6>
                       </div>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
           var table1 = $('#listTable').DataTable({
                ...
                "dom": "rtiplf",
                'ajax': {
                    'url':'phpajax/datagrid_approval.php?action=qc'
                },
                'order': [0, 'desc'],
                'columns': [
                    { data: 'id' },
                    { data: 'soid', "orderable": false },
                    { data: 'invoicedt', "orderable": false },
                    { data: 'organization', "orderable": false },
                    { data: 'orgbal', "orderable": false },
                    { data: 'amount_bdt', "orderable": false },
					{ data: 'empnm', "orderable": false },
					{ data: 'makedt', "orderable": false },
        ...
        $("#listTable").on("click",".actionbtn", function() {
            ...
            swal({
            title: "QC Approval",
            text: "Are you sure you want to proceed with this QC request? This action cannot be undone.",
            icon: "info",
            buttons: {
            cancel: {
              text: "Cancel",
