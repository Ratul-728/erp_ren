                	...
                	<form method="post" action="glmasterList.php" id="form1">
                     ...
                     <!-- <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Approval <i class="fa fa-angle-right"></i>All Damage Product</h6>
                       </div>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
           var table1 = $('#listTable').DataTable({
                ...
                "dom": "rtiplf",
                'ajax': {
                    'url':'phpajax/datagrid_approval.php?action=damage'
                },
                'order': [0, 'desc'],
                'columns': [
                    { data: 'id' },
        ...
        $("#listTable").on("click",".actionbtn", function() {
            ...
            swal({
            title: "Damage Product Approval",
            text: "Are you sure you want to proceed with this damage product? This action cannot be undone.",
            icon: "info",
            buttons: {
            cancel: {
              text: "Cancel",
