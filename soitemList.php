...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/soitem.php?res=0&msg='Insert Data'&mod=3");
    }
...
//WHERE  s.`status`<>6 order by s.`socode` asc"; 
    ...
    <span class="alertmsg">
                	...
                	<form method="post" action="soitemList.php?mod=3" id="form1">
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
            var table1 = $('#listTable').DataTable({
				...
				"dom": "rtiplf",
                'ajax': {
                    'url':'phpajax/datagrid_list_all.php?action=soitem'
                },
                'columns': [
                    { data: 'id' },
                    { data: 'srctype' },
