...
$pdf->SetXY(10, 20);
$pdf->Cell(0, 10, 'Repairable Products Report', 0, 1, 'C');
...
$pdf->Cell(20, 10, 'Repairable Qty', 1, 0, 'C', true);
...
if ($resultinv->num_rows > 0) {
    while ($row = $resultinv->fetch_assoc()) {
        ...
        $pdf->Cell(20, 10, $row["defect_qty"], 1);
...
$pdf->Output("I", "Repairable_Products_Report.pdf");
?>
