...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/approval_issue_order.php?res=0&msg='Insert Data'&mod=24");
    }
                	...
                	<form method="post" action="glmasterList.php" id="form1">
                     ...
                     <!-- <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Approval <i class="fa fa-angle-right"></i>All Issue Order</h6>
                       </div>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
           var table1 = $('#listTable').DataTable({
                ...
                "dom": "rtiplf",
                'ajax': {
                    'url':'phpajax/datagrid_approval.php?action=issue_order'
                },
                'order': [0, 'desc'],
                'columns': [
                    { data: 'id' },
        ...
        $("#listTable").on("click",".actionbtn", function() {
            ...
            swal({
            title: "Issue Order Approval",
            text: "Are you sure you want to proceed with this issue order? This action cannot be undone.",
            icon: "info",
            buttons: {
            cancel: {
              text: "Cancel",
...
//show INVOICE
   ...
   //alert(mylink);
  	...
  	BootstrapDialog.show({
							...
							title: 'Issue Order #'+$(this).data('code'),
