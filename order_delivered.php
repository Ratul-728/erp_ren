...
if ($usr == '') {header("Location: " . $hostpath . "/hr.php");
    ...
    if (isset($_POST['export'])) {
        ...
        ,d.name agnt FROM `orders` o left join orderstatus st on o.orderstatus=st.id left join deveryagent d on o.`deleveryagent`=d.id   where o.orderstatus in(5,8) " . $pqry . "
         and ( o.deliverydt between STR_TO_DATE('" . $fd1 . "','%d/%m/%Y') and STR_TO_DATE('" . $td1 . "','%d/%m/%Y'))";
        //echo  $qry;die;
             ...
             <span class="alertmsg"></span>
              ...
              <!-- START PLACING YOUR CONTENT HERE -->
                  <div class="panel panel-info">
          			   <div class="panel-heading"><h1>Delivered Orders</h1></div>
        				<div class="panel-body">


                        	<form method="post" action="order_delivered.php?mod=4" id="form1">
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-6">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control datepicker" id="to_dt" name="to_dt"  value="<?php echo $td1; ?>" required>
                                     <input type="hidden"  id="cmbsupnm" name="cmbsupnm"  value="1" >
                                </div>
                            </div>
                            <!--div class="col-lg-2 col-md-6 col-sm-6">
                                <div class="input-group">
        ...
        $(document).ready(function(){
            $('#listTable').on( 'draw.dt',  function () { putClass(); } )
				...
				scroller: true,
                 "dom": "rtiplf",
                'ajax': {
                    'url':'phpajax/datagrid_list_all.php?action=orderdelverd&lvl=2&fdt=<?php echo $fd1; ?>&tdt=<?php echo $td1; ?>&dagnt=<?php echo $dagent; ?>'
                },
                'columns': [
                    { data: 'order_id' },
                    { data: 'name' },
