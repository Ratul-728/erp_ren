...
else
{
    ...
    */
    $currSection = 'approval_itm_rate_change';
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
           var table1 = $('#listTable').DataTable({
                ...
                "dom": "rtiplf",
                'ajax': {
                    'url':'phpajax/datagrid_approval.php?action=itm_rate_chnage'
                },
                'order': [0, 'desc'],
                'columns': [
                    { data: 'id' },
                    ...
                    { data: 'currentrate', "orderable": false },
                    { data: 'newrate', "orderable": false },
					{ data: 'reason', "orderable": false },
					{ data: 'makeby', "orderable": false },
        ...
        $("#listTable").on("click",".actionbtn", function() {
            ...
            swal({
            title: "Product Rate Change Approval",
