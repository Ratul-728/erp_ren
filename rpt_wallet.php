    ...
    */
    ...
    if ( isset( $_POST['export'] ) ) {
       ...
       // echo  $qry;die;
        ...
        $objPHPExcel->getActiveSheet()->setTitle('Wallet Report ');
        $objPHPExcel->setActiveSheetIndex(0);
        $today=date("YmdHis");
        $fileNm="data/".'wallet_report'.$today.'.xls'; 
    ...
    <span class="alertmsg">
                    ...
                    <!--  <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Accounting <i class="fa fa-angle-right"></i> Wallet Report </h6>
                       </div>
                        ...
                        <div class="pull-right grid-panel form-inline">
                            ...
                            <div class="form-group">
                            <input type="hidden" id="pdfsource" url="pdf_rpt_wallet.php">
...
function table_with_filter(url){
	...
	url = 'phpajax/datagrid_list_all.php?action=rpt_wallet';
	table_with_filter(url);	
        ...
        $('#from_dt').datetimepicker({
            ...
            url = 'phpajax/datagrid_list_all.php?action=rpt_wallet&dt_f=' + fdt;
            table_with_filter(url);
        });
