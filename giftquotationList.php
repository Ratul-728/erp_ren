...
else
{
    ...
    */
    ...
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/gift_quotation.php?res=0&msg='Insert Data'&mod=3");
    }
                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Sales <i class="fa fa-angle-right"></i> All Gift Quotations</h6>
                       </div>
...
//			}],
    ...
    //url = 'phpajax/datagrid_quotation.php?action=quotation&currSection=<?=$currSection?>';
    url = 'phpajax/datagrid_quotation.php?type=gift&action=quotation';
	table_with_filter(url);	
        ...
        $("#cmbstatus").on("change", function() {
			...
			url = 'phpajax/datagrid_quotation.php?type=gift&action=quotation&cmbstatus='+status;
