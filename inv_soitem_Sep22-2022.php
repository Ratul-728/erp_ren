                                    ...
                                    <div class="row no-mg">
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label for="po_id">Order ID*dsfdsfsdf</label>
    ...
    <?php }} ?>
          	                                    ...
          	                                    <div class="col-lg-2 col-md-3 col-sm-3  col-xs-9">
                                                    ...
                                                    <div class="row qtnrows">
                                                        <div class="col-lg-3 col-md-4 col-sm-5 col-xs-4">
                                                            ...
                                                            <div class="form-group">
                                                                <input  type="number" min="1" class="numonly form-control quantity_otc qty-chkstk" id="quantity_otc" placeholder="Qty" name="quantity_otc[]">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-8">
														<label class="hidden-lg">Price*</label>
                                                            <div class="form-group">
                                                                <input type="text" class="numonly form-control unitprice_otc1 unitPriceV2" id="unitprice_otc1" placeholder="Price" name="unitprice_otc1[]">
                                                ...
                                                <!-- this block is for discount-->
                                                 <div class="col-lg-1 col-md-1 col-sm-1  col-xs-2">
													...
													<div class="form-group">
														<input type="number" min="0" max="100"  class="numonly form-control discnt" id="discnt"   placeholder="Discount %" name="discnt[]" >
													</div>
          	                                    ...
          	                                    <div class="col-lg-2 col-md-3 col-sm-3  col-xs-9"> <!-- this block is for quantity_otc, unitprice_otc-->
                                                    ...
                                                    <div class="row qtnrows">
                                                        <div class="col-lg-3 col-md-4 col-sm-5 col-xs-4">
															<label class="hidden-lg">Qty</label>
                                                            <div class="form-group">
                                                                <input type="number" min="1" class="numonly form-control quantity_otc qty-chkstk" id="quantity_otc" value="<?php echo $itdqu; ?>" name="quantity_otc[]">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-9 col-md-8 col-sm-7 col-xs-8">
															<label class="hidden-lg">Price</label>
                                            ...
                                            <div class="row total-row">
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="form-group grandTotalWrapper  label-flex pull-right">
                                                        ...
                                                        <input type="text" class="numonly form-control" id="discntnt" value="<?php echo  number_format($adj,2); ?>"  name="discntnt" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="form-group grandTotalWrapper  label-flex pull-right">
                                                        ...
                                                        <input type="text" class="numonly form-control" id="deliveryamt" value="<?php echo  number_format($deliveryamt,2); ?>"  name="deliveryamt" >
                                                    </div>
                                                </div>												
