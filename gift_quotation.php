...
<div id="wrapper">
    ...
    <div id="page-content-wrapper">
                                    ...
                                    <span class="alertmsg"></span>
                                        <div class="row form-header">
                                            <div class="col-lg-6 col-md-6 col-sm-6">
          		                                <h6>Gift Quotations <i class="fa fa-angle-right"></i> <?=($mode == 1)?"New":"Edit"?> Gift Quotation</h6>
          		                            </div>
                            ...
                            <!-- <br> -->
                          	<!-- <p>(Field Marked * are required) </p> -->
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <h4>Gift Quotation Information  </h4>
                                                <hr class="form-hr">
                                            </div> 
                                            <div class="col-lg-2 col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    <label for="po_id">Gift Quotation ID</label>
                                                        ...
                                                        <div class="ds-divselect-wrapper cat-name">
                                                            ...
                                                            <div class="list-wrapper">
                                                                <div class="ds-list">
                                                                    ...
                                                                    <?php $qryitm = "SELECT o.id, concat(o.name, '(', o.orgcode, ')') orgname ,concat(o.street,',',a.name,',',d.name,'-',o.zip,',',c.name) addr
        ...
        if($mode == 1) 
        { //insert 
            require_once("inc/inc_gift_quotation_insert.php");
         }else{ 
            // edit

            require_once("inc/inc_gift_quotation_edit.php");
        ...
        ?>									
                                                    ...
                                                    <div class="row total-row border">
                                                        <div class="col-xs-12">
                                                            <div class="form-group grandTotalWrapper label-flex pull-right">
                                                                ...
                                                                <input type="hidden" class="form-control f-subtotal" id="grandTotal" value="<?php echo str_replace(",","",$itdgt); ?>" readonly required>
                                                            </div>
                                                        </div>
                                                        
                                                        <input type="hidden" class="f-vatttl form-control" id_="vatdis" value="<?php echo  number_format($vatt,2, '.', ''); ?>"  name="vatdis"  readonly>
                                                        <input type="hidden" class="form-control" id_="vatt" value="<?php echo  $vatt; ?>"  name="vatt"  readonly>
                                                        <input type="hidden" class="calc  numonly f-adjmt form-control" id_="discntnt" value="<?php echo  number_format($adj,2, '.', ''); ?>"  name="discntnt" readonly>
                                                        <input type="hidden" class="f-disttl form-control" id_="discountdsp" value="<?php echo  number_format($netdisc,2, '.', ''); ?>"  name="discountdsp"  readonly>
                                                        ...
                                                        <div class="col-xs-12">
                                                            <div class="form-group grandTotalWrapper  label-flex pull-right">
                                                                ...
                                                                <input type="hidden" class="calc  numonly f-delcrg form-control" id_="deliveryamt" value="<?php echo  number_format($deliveryamt,2, '.', ''); ?>"  name="deliveryamt" >
                                                            </div>
                                                        </div>												
                                                      ...
                                                      <div class="col-xs-12">
                                                            <div class="form-group grandTotalWrapper  label-flex pull-right">
                                                                ...
                                                                <input type="hidden" class="f-grnd-ttl form-control" id_="grandTotalnet" value="<?php echo number_format($orGrandTotal,2,'.',''); ?>" readonly >
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-sm-12"> 
                                                    ...
                                                    //for update ?>
        												...
        												<input class="btn btn-lg btn-default" type="submit" name="postaction" value="Create Order"  id="confirm" > 
                                                  ...
                                                  <?php } ?>
        												...
        												<input  class="btn btn-lg btn-warning top" type="button" name="postaction" value="Cancel" id="cancel"  onClick="location.href = 'giftquotationList.php?pg=1&mod=3'" >
											...
											//alert(ajxdata[0].value);
													...
													$.ajax({
														  ...
														  success: function(res){
															  ...
															  $("#org_id").val(res.id);
															  getAddress(res.id);
															  $('.input-box').attr('value',res.name+"("+res.code+")");
															  $("#inpUl").append("<li class='pp1' value = '"+res.id+"'>"+res.name+" ("+res.code+")"+"</li>");
