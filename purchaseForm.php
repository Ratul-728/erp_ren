                            ...
                            <span class="alertmsg"></span>
                                   ...
                                   <div class="row form-header">
	                                     ...
	                                     <div class="col-lg-6 col-md-6 col-sm-6">
      		                                <h4>Inventory <i class="fa fa-angle-right"></i> Add Purchase Order </h4>
      		                            </div>
                                     ...
                                     <hr class="form-hr">
										...
										<div class="row">
											...
											<div class="col-lg-1 col-md-6 col-sm-6">
												 ...
												 <input type="hidden"  name="usrid" id="usrid" value="<?php echo $usr; ?>" >
												  <div class="form-group">
													 <label for="po_id">PO ID<span class="redstar">*</span></label>
											...
											<div class="col-lg-2 col-md-6 col-sm-6">
												<div class="form-group">
													<label for="po_id">Vouch No </label>
											...
											<div class="col-lg-2 col-md-6 col-sm-6">
												<div class="form-group">
													<label for="po_id">Proforma Invoice No </label>
													<input type="text" class="form-control" name="po_id" id="po_id" value="<?php echo $adv ?>" >
												</div>
											</div>
											
											<div class="col-lg-2 col-md-6 col-sm-6">
													<label for="email">Proforma Invoice Date<font color="red">*</font></label>
													<div class="input-group">
														<input type="text" class="form-control datepicker" id="delivery_dt" name="delivery_dt" value="<?php echo $delivery_dt; ?>" required>
														<div class="input-group-addon">
															<span class="glyphicon glyphicon-th"></span>
											...
											<div class="col-lg-1 col-md-6 col-sm-6">
												<div class="form-group">
													<label for="po_id"> Exchange Rate </label>
													<input type="text" class="form-control" name="po_id" id="po_id" value="<?php echo $adv ?>" >
												</div>
											</div>
											...
											<div class="col-lg-2 col-md-6 col-sm-6">
                                                ...
                                                <label for="cmbprdtp">Supplier<span class="redstar">*</span> </label>
...
<?php $qryrepto="SELECT s.`id`, s.`name` FROM `suplier` s order by s.name"; $resultrepto = $conn->query($qryrepto); if ($resultrepto->num_rows > 0) {while($rowrepto = $resultrepto->fetch_assoc()) 

      { 

          $reptoid= $rowrepto["id"];  $reptonm=$rowrepto["name"];
...
<?php  }}?>                                                       
                                            ...
                                            <div class="col-lg-2 col-md-6 col-sm-6">
                                                ...
                                                <label for="cmbprdtp">Warehouse/Location Arrived<span class="redstar">*</span> </label>
...
<?php $qryrepto="SELECT s.`id`, s.`name` FROM `branch` s order by s.name"; $resultrepto = $conn->query($qryrepto); if ($resultrepto->num_rows > 0) {while($rowrepto = $resultrepto->fetch_assoc()) 
...
<?php  }}?>                                                       
                                            ...
                                            <div class="col-lg-2 col-md-6 col-sm-6">
                                                ...
                                                <label for="cmbprdtp">Recieved By<span class="redstar">*</span> </label>
...
<?php $qryrepto="SELECT id, concat(firstname, ' ', lastname) AS name FROM `employee` order by name"; $resultrepto = $conn->query($qryrepto); if ($resultrepto->num_rows > 0) {while($rowrepto = $resultrepto->fetch_assoc()) 
									...
									<div class="po-product-wrapper withlebel">
                                        <div class="color-block">
	                                        ...
	                                        <div class="col-lg-3 col-md-6 col-sm-6">
                                                ...
                                                <label for="cmbprdtp">Bank <span class="redstar">*</span> </label>
...
<?php  }}?>                                                       
											...
											<div class="col-lg-3 col-md-6 col-sm-6">
												<label for="email">Amount<font color="red">*</font></label>
												<div class="input-group">
													<input type="text" class="form-control" id="delivery_dt" name="delivery_dt" value="" required>
												</div>
											</div>
											
											<div class="col-lg-3 col-md-6 col-sm-6">
												<label for="email">Remarks<font color="red">*</font></label>
												<div class="input-group">
													<input type="text" class="form-control" id="delivery_dt" name="delivery_dt" value="" required>
												</div>
											</div>
...
<?php if ($mode == 1 || $mode == 5) { ?>
                                            <div class="row hidden-xs hidden-sm hidden-md">
                                                <div class="col-lg-4 col-md-6 col-sm-6">
                                                    <h6 class="chalan-header mgl10"> Select Item <font color="red">*</font> </h6>
                                                </div>
                                                <div class="col-lg-2 col-md-6 col-sm-6">
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-6">
                                                    <h6 class="chalan-header"> Select Store<font color="red">*</font> </h6>
                                                </div>
...
$rCountLoop = 0;
        $itdgt      = 0;
        $itmdtqry   = "SELECT   pi.`poid`, pi.`itemid`, pi.`description`, pi.`qty`, pi.`unitprice`,pi.mrp, pi.`amount`,DATE_FORMAT(pi.`expirydt`,'%e/%c/%Y') expirydt,pi.storerome,i.name itmnm,i.code FROM `poitem` pi left join item i on pi.itemid=i.id WHERE poid='" . $poid . "'";
//echo $itmdtqry;die;
        $resultitmdt = $conn->query($itmdtqry);if ($resultitmdt->num_rows > 0) {while ($rowitmdt = $resultitmdt->fetch_assoc()) {
            ...
            $itdup  = ($qty * $unitprice);
            $itdgt  = $itdgt + $itdup;
            $itmnm   = $rowitmdt["itmnm"].'-('.$rowitmdt["code"].')';
            ?>
                                            ...
                                            <div class="toClone">
                                                <div class="col-lg-3 col-md-6 col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                       <!--<input type="text" class="form-control" id="itemName" placeholder="Item Name (White Roll)" name="itemName[]"> -->
                                                        <div class="form-group styled-select">
                                                            <input list="itemName"  autocomplete="off" value = "<?= $itmnm ?>"  class="dl-itemName datalist" placeholder="Select Item">
                                                            <datalist  id="itemName" class="list-itemName form-control">
                                                                <!--option value="">Select Item</option -->
    <?php $qryitm = "SELECT `id`, code,`name`, `vat`, `ait`, `cost`,rate  FROM `item`  order by name";
            $resultitm        = $conn->query($qryitm);if ($resultitm->num_rows > 0) {while ($rowitm = $resultitm->fetch_assoc()) {
                ...
                $up   = number_format($rowitm["cost"], 2);
                ?>
                                                                <option data-value="<?php echo $tid; ?>"  data-up="<?php echo $up; ?>" data-cost="<?php echo $cost; ?>" data-vat="<?php echo $vat; ?>" data-ait="<?php echo $ait; ?>" data-mrp="<?php echo $rate; ?>" value="<?php echo $nm; ?>" <?php if ($itmdtid == $tid) {echo "selected";} ?>><?php echo $nm; ?></option>
    <?php }} ?>
                                                            </datalist>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-6">
                                                    ...
                                                    <div class="row qtnrows">
                                                        ...
                                                        <div class="col-lg-12 col-sm-6 col-xs-6">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" class="form-control quantity_otc" id="quantity_otc" placeholder="Quantity" name="quantity_otc[]" value="<?php echo $qty; ?>" required>
                                                            </div>
                                                        </div>
                                                        <!--<div class="col-lg-8 col-sm-6 col-xs-6">
															<lebel>OTC</lebel>
                                                            <div class="form-group">
                                                                <input readonly type="text" class="form-control unitprice_otc1 unitPriceV2" id="unitprice_otc1" value="<?php echo number_format($unitprice, 2); ?>" name="unitprice_otc1[]" required>
                                                        ...
                                                        <input type="hidden"  class="form-control unitprice_otc" name="unitprice_otc[]" id="unitprice_otc" value="<?php echo $unitprice; ?>">
                                                        <input type="hidden" name="unitTotalAmount_otc" class="unitTotalAmount_otc" value="<?php echo $cost; ?>">
                                                    </div>
                                                </div> <!-- this block is for quantity_otc, unitprice_otc-->
                                                <!--
                                                <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6">
          	                                     ...
          	                                     <div class="col-lg-3 col-md-6 col-sm-6">
          	                                                <input type="hidden" class="form-control unitTotalAmount1" id="unittotal1" placeholder="Unit Total" readonly  value="<?php echo $itdtot; ?>"  name="unittotal1[]">
                                                            <input type="hidden"  class="form-control unitTotalAmount" name="unittotal[]" id="unittotal" value="<?php echo $amount; ?>">
                                                             <input type="hidden" class="form-control unitpricemrc" id="unitpricemrc" placeholder="MRP" name="unitpricemrc[]"  value="<?php echo $mrp; ?>" required>
                                                    <div class="form-group">
                                                       <!--<input type="text" class="form-control" id="itemName" placeholder="Item Name (White Roll)" name="itemName[]"> -->
                                                        <div class="form-group styled-select">
                                                        <select name="storeName[]" i d="storeName" class="storeName form-control" required>
...
<?php }} else {
    ...
    <?php }} ?>
                                                 ...
                                                 <div class="col-lg-3 col-md-6 col-sm-6">
                                                    <div class="row qtnrows">
                                                        ...
                                                        <div class="col-lg-12 col-sm-6 col-xs-6">
															<!--<lebel>Quantity</lebel>-->
                                                            <div class="form-group">
                                                                <input type="text" class="form-control quantity_otc" id="quantity_otc" placeholder="Quantity" name="quantity_otc[]" required>
                                                            </div>
                                                        </div>
                                                        <!--<div class="col-lg-8 col-sm-6 col-xs-6">
															<lebel>OTC</lebel>
                                                            <div class="form-group">
                                                                <input readonly type="text" class="form-control unitprice_otc1 unitPriceV2" id="unitprice_otc1" placeholder="OTC" name="unitprice_otc1[]" required>
                                                                <input type="hidden" class="form-control unitprice_otc unitPriceV2" id="unitprice_otc" name="unitprice_otc[]" class="unitprice_otc">
                                                                <input type="hidden" name="unitTotalAmount_otc" class="unitTotalAmount_otc">
                                                            </div>
                                                        </div>-->
                                                                <input readonly type="hidden" class="form-control unitprice_otc1 unitPriceV2" id="unitprice_otc1" placeholder="OTC" name="unitprice_otc1[]" >
                                                                <input type="hidden" class="form-control unitprice_otc unitPriceV2" id="unitprice_otc" name="unitprice_otc[]" class="unitprice_otc" value="0">
                                                                <input type="hidden" name="unitTotalAmount_otc" class="unitTotalAmount_otc" value="0">
                                                    </div>
                                                </div> <!-- this block is for quantity_otc, unitprice_otc-->
                                                ...
                                                <div class="col-lg-3 col-md-6 col-sm-6">
                                                            <input type="hidden" class="form-control unitTotalAmount1" id="unittotal1" placeholder="Unit Total" readonly  name="unittotal1[]" value="0">
                                                            <input type="hidden"  class="form-control unitTotalAmount" name="unittotal[]" id="unittotal" value="0">
                                                            <input type="hidden" class="form-control unitpricemrc" id="unitpricemrc" placeholder="MRP" name="unitpricemrc[]"  value="0" >
                                                    <div class="form-group">
                                                       <!--<input type="text" class="form-control" id="itemName" placeholder="Item Name (White Roll)" name="itemName[]"> -->
