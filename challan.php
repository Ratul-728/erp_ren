                                ...
                                <div class="row">
									...
									<div class="col-sm-6">
										<div class="row">
											...
											<div class="col-sm-6">
												 ...
												 <input type="hidden"  name="usrid" id="usrid" value="<?php echo $usr; ?>" >
												  <div class="form-group">
													 <label for="po_id">Stock In No<span class="redstar">*</span></label>
											...
											<div class="col-lg-6 col-md-6 col-sm-6">
												<div class="form-group">
													<label for="po_id">Reference No </label>
											 ...
											 <div class="col-lg-6 col-md-6 col-sm-6"> 
												...
												<div class="col-lg-6 col-md-6 col-sm-6">
													<label for="email">Receive Date<font color="red">*</font></label>
      	                            ...
      	                            <!--div class="col-lg-3 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="cmbsupnm">Supplier*</label>
    ...
    $resultitm                            = $conn->query($qryitm);if ($resultitm->num_rows > 0) {while ($rowitm = $resultitm->fetch_assoc()) {
        ...
        $nm  = $rowitm["name"]; ?>
                        ...
                        <?php }} ?>
                                                    ...
                                                    <input type = "hidden" name = "cmbsupnm" id = "cmbsupnm" value = "<?=$supid ?>">
                                                </div>
                                        </div>
                                    </div-->
