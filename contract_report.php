...
else
{
   ...
   if ( isset( $_POST['export'] ) ) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
    			...
    			->setCellValue('F1', 'Contruct Ending Time');
       ...
       // echo  $qry;die;
        ...
        $objPHPExcel->getActiveSheet()->setTitle('CONTRUCT_REPORT');
        $objPHPExcel->setActiveSheetIndex(0);
        $today=date("YmdHis");
        $fileNm="data/".'contruct_report'.$today.'.xls'; 
                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                        ...
                        <div class="col-sm-3 text-nowrap">
                            <h6>HRM <i class="fa fa-angle-right"></i>Contractual Report</h6>
                       </div>
  ...
  <div class="col-sm-9 text-nowrap"> 
                        ...
                        <div class="pull-right grid-panel form-inline">
                                ...
                                <div class="form-group">
  									<label for="">Filter by Contract Ending Time: </label>
                                </div>
...
?>
     ...
     <!-- Datatable JS -->       
		...
		url = 'phpajax/datagrid_list_all.php?action=contract_report';
        ...
        $("#month, #year").on("change", function() {
			...
			url = 'phpajax/datagrid_list_all.php?action=contract_report&month='+month+'&year='+year;
