                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>SCM <i class="fa fa-angle-right"></i> Return Order </h6>
                       </div>
...
//			}],
				...
				'columns': [
                    ...
                    { data: 'roid' },
                    { data: 'order_id' },
                	{ data: 'orderdate', 'orderable': false  },	//Order Amount
            		{ data: 'customer', 'orderable': false  },
            		{ data: 'noitems' , 'orderable': false },
            		{ data: 'total_qty' , 'orderable': false },//accoutn manager
    ...
    url = 'phpajax/datagrid_scm.php?action=returnorder';
	table_with_filter(url);	
        ...
        $("#cmbstatus, .dl-itemName").on("change", function() {
			...
			url = 'phpajax/datagrid_qa.php?action=returnorder&customer='+dataValue+'&cmbstatus='+status;
