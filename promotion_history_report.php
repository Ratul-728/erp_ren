...
else
{
    ...
    */
    $currSection = 'promotion_history_report';
   ...
   if ( isset( $_POST['export'] ) ) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('D1', 'Previous Designation')
    			->setCellValue('E1', 'Promotion Date')
    			->setCellValue('F1', 'New Designatio')
    			->setCellValue('G1', 'Increment Amount')
    			->setCellValue('H1', 'New Gross Salary');
       ...
       // echo  $qry;die;
        ...
        { $i=0;
            ...
            { 
                ...
                $objPHPExcel->setActiveSheetIndex(0)
    			            ->setCellValue($col1, $i)
    			            ->setCellValue($col2, $row["emp"])
    			            ->setCellValue($col3, $row["employeecode"])
    						->setCellValue($col4, $row["prevDesgnm"])
    					    ->setCellValue($col5, $row["promotionDate"])
    					    ->setCellValue($col6, $row["deisgNm"])
    					    ->setCellValue($col7, $row["increment"])
    						->setCellValue($col8, $row["newgross"]);
    					     
    					    	/* */
    			//$laststyle=$title;	
            }
        }
        $objPHPExcel->getActiveSheet()->setTitle('PROMOTION_HISTORY_REPORT');
        $objPHPExcel->setActiveSheetIndex(0);
        $today=date("YmdHis");
        $fileNm="data/".'promotion_history_report'.$today.'.xls'; 
    ...
    <div id="wrapper"> 
      ...
      <div class="section">
        ...
        <span>Promotion History Report</span>
      </div>
                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                        ...
                        <div class="col-sm-3 text-nowrap">
                            <h6>HRM <i class="fa fa-angle-right"></i>Promotion History Report</h6>
                       </div>
...
?>
     ...
     <!-- Datatable JS -->       
		...
		url = 'phpajax/datagrid_list_all.php?action=promotion_history';
