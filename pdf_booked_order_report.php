...
$loop = "";
    $qry="SELECT s.`id`, s.`socode`,tp.`name` `srctype`,c.`name` `customer`,o.`name` organization, date_format(s.`orderdate`,'%d/%m/%y') `orderdate`,
                                        ...
                                        WHERE s.orderstatus=9 ORDER BY  s.id DESC";
    	  //echo  $qry;die;
	...
	<tr>
		...
		<td '.$tdStyle.' nowrap>'.$rowinv["srctype"].'</td>
...
$obj_pdf->SetTitle("Booked Order Report");
...
<table width="100%" border="0"  cellspacing="0" cellpadding="0">
   <thead>
	<tr>
		...
		<td width="50%" align="right"><h1>Booked Order Report</h1></td>
	</tr>
	</thead>		
</table>		
...
$obj_pdf->OutPut("Booked_Order_Report","I");
//echo $content;
}
?>
