...
<?php
$sosl = 1;
$dqry   = "SELECT i.barcode, i.name product, i.dimension, i.image, ror.return_qty, qaw.ordered_qty, i.description, i.parts
            ...
            LEFT JOIN `return_order` ro ON ro.id=ror.ro_id WHERE ro.ro_id = '".$roid."'";
