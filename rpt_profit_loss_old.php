...
else
{
   ...
   $currSection = 'rpt_profit_loss_old';
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid xyz">
                <div class="row">
                    ...
                    <form method="post" action="rpt_profit_loss_old.php?pg=1&mod=7" id="form1" enctype="multipart/form-data">  
                        <!-- START PLACING YOUR CONTENT HERE -->
                        <div class="button-bar">
                            ...
                            <?php include_once('phpajax/rpt_load_profit_loss_old.php'); ?> 
        <!-- /#end of panel -->
                    </form>
