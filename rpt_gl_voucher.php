...
else
{
   ...
   if ( isset( $_POST['export'] ) ) {
        ...
        $firststyle='A2';
        $qry="select a.VouchNo,DATE_FORMAT(a.TransDt, '%Y-%m-%d') TransDt ,a.refno,a.remarks,d.sl,d.glac,g.glnm,org.name customer,
        ...
        { $i=0;
            ...
            { 
                ...
                $objPHPExcel->setActiveSheetIndex(0) 
                            ...
                            ->setCellValueByColumnAndRow(12, $urut, date('d-m-y', PHPExcel_Shared_Date::ExcelToPHP($date_cell)));
    					    	/* */ 
    			//$laststyle=$title;	
            }
        }
