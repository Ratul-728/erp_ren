            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-info">
      		            ...
      		            <div class="panel-heading"><h1 class="left-align" >Edit Stock Order</h1></div>
		                                ...
		                                <hr class="form-hr">
		                                 ...
		                                 <input type="hidden"  name="cmbsupnm" id="cmbsupnm" value="<?php echo $supid; ?>" >
		                                  ...
		                                  <div class="form-group">
    		                                 ...
    		                                 <label for="po_id">Stock In No*</label>
...
$rCountLoop = 0;
    ...
    $itmdtqry   = "SELECT  a.`poid`, a.`itemid`, a.`description`, a.`qty`, a.`unitprice`,a.mrp, a.`amount`,DATE_FORMAT(a.`expirydt`,'%e/%c/%Y') expirydt,a.storerome, b.name itemnm 
                                                    ...
                                                    <div class="row qtnrows">
                                                        ...
                                                        <div class="col-lg-4 col-sm-6 col-xs-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" min="1" class="form-control quantity_otc_po" id="quantity_otc_po" placeholder="Quantity" name="quantity_otc_po[]" value="<?php echo $qty; ?>" required>

                                                                <input type="hidden" class="form-control quantity_otc" id="quantity_otc" placeholder="Quantity" name="quantity_otc[]" value="<?php echo $qty; ?>">
														...
														<!--	<lebel>OTC</lebel>-->
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input  type="text" class="form-control unitprice_otc_po unitPriceV2" id="unitprice_otc_po" value="<?php echo number_format($unitprice,2); ?>" name="unitprice_otc_po[]">
...
<?php }} ?>
        ...
        <!-- /#end of panel -->
                    ...
                    <div class="button-bar">
                          ...
                          <input  dat a-to="pagetop" class="btn btn-lg btn-default top" type="submit" name="update" value="Update Challan" id="update" >
