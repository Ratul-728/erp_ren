...
if ($usr == '') {header("Location: " . $hostpath . "/hr.php");
    ...
    $currSection = 'rpt_available_stock_summary';
    ...
    if (isset($_POST['export'])) {
        ...
        $objPHPExcel->getActiveSheet()->setTitle('Available Stock Summary Report');
        $objPHPExcel->setActiveSheetIndex(0);
        $today     = date("YmdHis");
        $fileNm    = "data/" . 'rpt_available_stock_summary' . $today . '.xls';
...
include_once 'menu.php';
    ...
    <span class="alertmsg">
                	...
                	<form method="post" action="rpt_available_stock_summary.php?mod=3" id="form1">
                         <div class="well list-top-controls">
                            ...
                            <h6>Inventory <i class="fa fa-angle-right"></i> Available Stock Summary</h6>
                       </div>
                                      </div>
...
function table_with_filter(url){
	...
	url = 'phpajax/datagrid_list_all.php?action=rpt_available_stock_summary&brand=0&cat=0';
	table_with_filter(url);	
	
	//Status
        $("#cmbbrand,#cmbcat").on("change", function() {
			...
			url = 'phpajax/datagrid_list_all.php?action=rpt_available_stock_summary&brand='+brand+'&cat='+cat;
    ...
    <script>
		//convert pdf trigger;
			...
			$("#exportpdf").on("click",function(){
				...
				var pdfurl = 'pdf_available_stock_summary.php?brand='+brand+'&cat='+cat;
