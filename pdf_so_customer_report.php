...
$loop = "";
    $qry="SELECT s.id,s.socode,o.name organization ,i.name product
          ...
          left join item i on d.productid=i.id  ORDER BY  s.id DESC";
    	  //echo  $qry;die;
...
$obj_pdf->SetTitle("Service Order Product Wise Report");
...
<table width="100%" border="0"  cellspacing="0" cellpadding="0">
   <thead>
	<tr>
		...
		<td width="50%" align="right"><h1>Service Order Product Wise Report</h1></td>
	</tr>
	</thead>		
</table>		
...
$obj_pdf->OutPut("Service_Order_Product_Wise_Report_","I");
//echo $content;
}
?>
