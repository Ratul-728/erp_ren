                	...
                	<form method="post" action="#" id="form1">
                     ...
                     <!-- <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Billing <i class="fa fa-angle-right"></i>All Payment Voucher</h6>
                       </div>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
           var table1 = $('#listTable').DataTable({
                ...
                "order": [[ 0, "desc" ]],
                'ajax': {
                    'url':'phpajax/datagrid_list_all.php?action=return_payment&filterorg=<?=$filterorg ?>&fdt=<?=$fdt ?>&tdt=<?=$tdt ?>'
                },
                'columns': [
                    { data: 'sl' },
                    { data: 'narration' },
