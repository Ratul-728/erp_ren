...
else
{
   ...
   if ( isset( $_POST['export'] ) ) {
        ...
        $qry="SELECT doi.do_id, doi.do_date, doi.start_time,doi.start_time,doi.end_time,doi.order_id,ds.name stnm, ds.dclass,resourceplan,
                                ...
                                WHERE doi.type=3  GROUP BY doi.do_id  order by doi.`id` desc";
//WHERE  s.`status`<>6 order by s.`socode` asc"; 
       ...
       // echo  $qry;die;
        ...
        $objPHPExcel->setActiveSheetIndex(0);
        $today=date("YmdHis");
        $fileNm="data/".'RETURN_ORDER_DELIVERY_'.$today.'.xls'; 
                     ...
                     <div class="well list-top-controls"> 
                      <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6> SCM <i class="fa fa-angle-right"></i>Return Order Delivery Status </h6>
                       </div>
...
//			}],
    ...
    url = 'phpajax/datagrid_scm.php?action=returndelivery';
