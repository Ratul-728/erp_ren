...
else
{
    ...
    */
    $currSection = 'approval_withdrawal';
    include_once('common/inc_session_privilege.php');
    $currPage = basename($_SERVER['PHP_SELF']);
    
    if ( isset( $_POST['add'] ) ) {
           header("Location: ".$hostpath."/approval_withdrawal.php?res=0&msg='Insert Data'&mod=24");
    }
                	...
                	<form method="post" action="glmasterList.php" id="form1">
                     ...
                     <!-- <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Approval <i class="fa fa-angle-right"></i>All Withdrawal Request</h6>
                       </div>
     ...
     <!-- Datatable JS -->       
        ...
        $(document).ready(function(){
           var table1 = $('#listTable').DataTable({
                ...
                "dom": "rtiplf",
                'ajax': {
                    'url':'phpajax/datagrid_approval.php?action=withdrawal'
                },
                'order': [0, 'desc'],
                'columns': [
                    { data: 'id' },
