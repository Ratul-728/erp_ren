                         ...
                         <div class="well list-top-controls">
                                  <div class="row border">
                                        ...
                                        <div class="col-sm-3  text-nowrap">
                                                <h6>Finance <i class="fa fa-angle-right"></i> All Invoices</h6>
...
$(document).ready(function(){
	...
	url = 'phpajax/datagrid_invoice.php?action=financialcustomization&fdt=<?=$fdt ?>&tdt=<?=$tdt ?>&yeardt=<?=$yeardt ?>';
...
$('#filter_date_from').daterangepicker({
  ...
  console.log("New date range selected: ' + start.format('YYYY-MM-DD') + ' to ' + end.format('YYYY-MM-DD') + ' (predefined range: ' + label + ')");
	...
	if(start<end){
	url = 'phpajax/datagrid_invoice.php?action=financialcustomization&dt_f='+start.format('YYYY-MM-DD')+'&dt_t='+end.format('YYYY-MM-DD');
	}
	else
	{
	url = 'phpajax/datagrid_invoice.php?action=financialcustomization&dt_f='+end.format('YYYY-MM-DD')+'&dt_t='+start.format('YYYY-MM-DD');
	}
	//alert(url);
	//setTimeout(function(){
		table_with_filter(url);
...
$(".cancelBtn").click(function(){
	...
	url = 'phpajax/datagrid_invoice.php?action=financialcustomization';
	table_with_filter(url);
});
