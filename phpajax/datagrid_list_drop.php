...
## Search 
        ...
        if($searchValue != '')
        {
        	$searchQuery = " and (t.`tikcketno` like '%".$searchValue."%' or  date_format(t.`issuedate`,'%d/%b/%y') like '%".$searchValue."%' or  t.`issuedetails` like '%".$searchValue."%' or 
                 ...
                 or  date_format(t.`probabledate`,'%d/%b/%y') like '%".$searchValue."%'  or t.`severity` like '%".$searchValue."%' or h1.hrName like '%".$searchValue."%' 
...
left join issuepriority p on t.severity=p.id where 1=1 ";
        ...
        $strwithsearchquery=$strwithoutsearchquery.$searchQuery.$sortqry;
  // s.`status`<>6 
          ...
          // $action='<span><a href="invoice.php?invid='.$row['invoiceno'].' &mod=2" class="invoice-view" title="View"><i class="fa fa-search"></i></a>
           ...
           //<a href="#" class="invoice-regenerate" title="Re-generate"><i class="fa fa-refresh"></i></a></span>';
            $humbar = '<div class="dropdown dropright">
                                        <div class="fa fa-bars dropdown-toggle" 
