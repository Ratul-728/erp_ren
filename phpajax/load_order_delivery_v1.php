 										...
 										<table class="tbl-bill delivery-table" width="100%" border="1" cellspacing="5" cellpadding="5">
                                             ...
                                             <thead>
                                                ...
                                                <tr style="background-color:#E7E7E7">
                                                    ...
                                                    <th class="store-td" style="width: 200px; background-color: ">Warehouse</th>
													...
													<!--th width="10"  style="text-align: center;width: 10px;">Rate</th>
                                                    <th width="10"  style="text-align: center;width: 10px;"	>Amount </th>

                                                    <th width="10"  style="text-align: center;width: 10px;">VAT</th-->
    ...
    ?>  
											...
											<tr class="prdct-row proid-<?=$prd?>" <?=(number_format($quantity, 0) == $deliveredqty)?'style="background-color:#c2e6b8;"':''?>>
                                                  ...
                                                  <td align="center"><?=$deliveredqty?> <input type="hidden" name="deliveredqty[<?=$prd?>]"  class="delivered-qty" value="<?=$deliveredqty?>"></td>  
                                                    ...
                                                    <td colspan="3" class="store-wrapper" style="width: 400px; padding:0!important; border: 0!important;">
														...
														<tr>
															...
															<td style="width: 100px">
																...
																<input type="number" <?=(number_format($quantity, 0) == $deliveredqty)?'disabled':''?> min="0" max="<?=($freeqty<$dueqty)?$freeqty:$dueqty?>" class="delivery-qty form-control  text-center" tabindex="<?=$tabindex?>" name="deliveryqty[<?=$prd ?>][<?=$stid?>]"  value="" >															
															</td>
														</tr>
													...
													<!--td><?php echo number_format($rate, 2); ?><input type="hidden" name="rate[<?=$prd ?>]" value="<?php echo number_format($rate, 2); ?>"></td>
                                                    <td><?php echo number_format($total, 2); ?><input type="hidden" name="unittotal[<?=$prd ?>]" value="<?php echo number_format($total, 2); ?>"></td>

                                                    <td><?php echo number_format($vat1, 2); ?><input type="hidden" name="vat[<?=$prd ?>]" value="<?php echo number_format($vat1, 2); ?>"></td-->

                                                    <td><?php echo number_format(($total + $vat1), 2); ?><input type="hidden" name="total[<?=$prd ?>]" value="<?php echo number_format(($total + $vat), 2); ?>"</td>
