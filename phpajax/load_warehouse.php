    			...
    			<div class="row border">
                            ...
                            <div class="col-xs-4">
                                  <div class="input-group plusminuswrap">
                                    ...
                                    <input type="text" <?=$isDisabled?> id="quantity1" data-stklimit="<?=$wh['quantity']?>" name="whqty[<?=$pid?>][]" class="form-control input-number numonly quantity" value="0" min="0" max="<?=$wh['quantity']?>">
                                    <span class="input-group-btn">
                            ...
                            <div class="col-xs-4">
                                <div class="input-group">
                                    <input type="text" <?=$isDisabled?> class="form-control datetimepicker-wh delivery-date<?=$isDisabled?>"  name="delivery_date[<?=$pid?>][]" id="date_<?=$wh['name']?>_<?=$pid?>" placeholder="Delivery Date" r equired="">
