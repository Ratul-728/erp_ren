...
if($type == 1){
    ...
    $area = $_POST["data"][2]["value"];
    
    $contnm = $_POST["data"][3]["value"];
    $email = $_POST["data"][4]["value"];
    $phoneno = $_POST["data"][5]["value"];
    $note = $_POST["data"][6]["value"];
	...
	*/
    ...
    $qry="insert into organization(`name`,`orgcode`,  `contactno`, `industry`, `email`, `street`, `note`) 
                            values('".$nm."','".$orcode."','".$phoneno."',".$cmbindtype.",'".$email."','".$area."','".$note."')" ;
    //echo $qry;die;
