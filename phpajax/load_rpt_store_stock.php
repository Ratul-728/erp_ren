...
<?php 
$tcp=0;$tmp=0;
$qry2="SELECT g.name gn,c.title cn,t.name tn,p.name pn,s.freeqty,s.bookqty,s.costprice,p.mrp,r.name str,s.barcode FROM chalanstock s ,product p ,catagorygrouping cg,itemgroup g,catagory c, itemtype t ,storeroom r
where s.product = p.id 
and p.catagory=cg.itemtype and cg.itemgroup=g.id and cg.itemcatagory=c.id and cg.itemtype=t.id and s.storerome=r.id
and (s.storerome=".$dagent." or ".$dagent." =0) and (s.barcode='".$bc1."' or '".$bc1."'='') 
