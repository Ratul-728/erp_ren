 											...
 											<div class="tbl-bhbs-wrapper">
                                				<table class="tbl-bhbs" width="100%" border="0" cellspacing="0" cellpadding="0">
                                				  <tbody>
                                        			...
                                        			<?php 
                                        			        $lvl2tot=0;
                                        			        $lvl3="SELECT c.glno,c.glnm,(c.opbal+c.inventory_adjust) opbal  FROM `coa_mon` c  where c.ctlgl=$gl2 and c.yr='$pyr' and c.mn='7' and c.oflag='N'";
                                        			       // echo $lvl3;die;
   ...
   (m.transdt Between '$f_dt' and '$t_dt')
                                					...
                                					?>
                                        					<tr class="liabilities"> 
                                        					  <td class="gp-1"><strong><?php echo $Lglnm2;?></strong></td>
                                        					  <td class="gp-1">&nbsp;</td>
                                        					</tr>
                                        			<?php 
                                        			        $Llvl2tot=0;  
...
select  0 damt,COALESCE(sum(d.amount),0) camt from glmst m,gldlt d where m.vouchno=d.vouchno and d.glac in (select glno from coa where ctlgl in (select glno from coa where ctlgl='$Lgl3')) and d.dr_cr='C' and m.isfinancial in('0','A')  and
   (m.transdt Between '$f_dt' and '$t_dt')
                                                    ...
                                                    ?>  
                                                                    <tr class="cash-bank-balance">
                                            					        <td class="gp-2"><?php echo $Lglnm3;?></td>
                                                					    <td class="gp-2" align="right"><?php echo number_format(($Lopbal3+$Lclosingbal3),2);?></td>
                                            					    </tr> 
                                				    <?php /*
                                            			            $lvl4="SELECT c.glno,c.glnm,c.closingbal FROM `coa_mon` c  where c.ctlgl=$gl3 and c.yr='$pyr' and c.mn='$pmn'";
                                        					        $result4 = $conn->query($lvl4);
                                                    ...
                                                    ?>
                                                                    <!--tr class="accounts-payable">
                                				                        <td  class="gp-2 total-title">Total <?php echo $Lglnm3;?></td>
                                					                    <td class="total-amount"><?php echo number_format($Lclosingbal3,2);?></td>
                                					                </tr-->
                                                    <?php
                                                                }
                                                            }
                                                    ?>
                                                                <tr class="liabilities">
                                					                <td  class="gp-1 total-title">Total <?php echo $Lglnm2;?></td>
                                					                <td class="total-amount" align="right"><?php echo number_format($Llvl2tot,2);?></td>
                                				                </tr>
                                                    <?php
                                        			    }
                                        			}
                                        			...
                                        			<tr class="end-parent liabilities">
                                					  ...
                                					  <?php
                                                        ...
                                                        //$closingbal1= $row1["closingbal"];
                                                            ?>
                                					  <td class="total-amount" align="right"><span><?php echo number_format($Llvl1tot,2);?></span></td>
                                					</tr>
                                					<tr>
                                					  <td>&nbsp;</td>
                                					  <td>&nbsp;</td>
