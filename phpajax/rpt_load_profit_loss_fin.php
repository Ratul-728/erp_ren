...
<?php $gt=0;
$lvl1="SELECT c.glno,c.glnm FROM `coa` c  where substring(c.glno,1,1) in('4') and c.lvl=2 ";
        ...
        if ($result2->num_rows > 0) 
        {
            ...
            { 
                ...
                $amtqry="select (sum(damt)-sum(camt)) amt from
                            (
                            select COALESCE(sum(d.amount),0) damt,0 camt from gldlt d,glmst m where m.VouchNo=d.VouchNo and  d.dr_cr='D'  and   d.glac='$gl2' and m.isfinancial in ('0','Y') and
   (m.transdt Between STR_TO_DATE('$fd', '%d/%m/%Y') and STR_TO_DATE('$td', '%d/%m/%Y'))
                            union all
                            select COALESCE(sum(d.amount),0) damt,0 camt from gldlt d,glmst m where m.VouchNo=d.VouchNo and  d.dr_cr='D' and d.glac in (select glno from coa where ctlgl='$gl2') and m.isfinancial in ('0','Y') and
   (m.transdt Between STR_TO_DATE('$fd', '%d/%m/%Y') and STR_TO_DATE('$td', '%d/%m/%Y'))
   
                            union all
                            select COALESCE(sum(d.amount),0) damt,0 camt from gldlt d,glmst m where m.VouchNo=d.VouchNo and  d.dr_cr='D' and d.glac in (select glno from coa where ctlgl in (select glno from coa where ctlgl='$gl2')) and m.isfinancial in ('0','Y') and
   (m.transdt Between STR_TO_DATE('$fd', '%d/%m/%Y') and STR_TO_DATE('$td', '%d/%m/%Y'))
                            union all
                            select 0 damt,COALESCE(sum(d.amount),0) camt from gldlt d,glmst m where m.VouchNo=d.VouchNo and  d.dr_cr='C'  and   d.glac='$gl2' and m.isfinancial in ('0','Y') and 
   (m.transdt Between STR_TO_DATE('$fd', '%d/%m/%Y') and STR_TO_DATE('$td', '%d/%m/%Y'))
                            union all
                            select 0 damt,COALESCE(sum(d.amount),0) camt from gldlt d,glmst m where m.VouchNo=d.VouchNo and  d.dr_cr='C' and d.glac in(select glno from coa where ctlgl='$gl2') and m.isfinancial in ('0','Y') and 
   (m.transdt Between STR_TO_DATE('$fd', '%d/%m/%Y') and STR_TO_DATE('$td', '%d/%m/%Y'))
                            union all
                            select 0 damt,COALESCE(sum(d.amount),0) camt from gldlt d,glmst m where m.VouchNo=d.VouchNo and  d.dr_cr='C' and d.glac in (select glno from coa where ctlgl in (select glno from coa where ctlgl='$gl2'))  and m.isfinancial in ('0','Y') and 
   (m.transdt Between STR_TO_DATE('$fd', '%d/%m/%Y') and STR_TO_DATE('$td', '%d/%m/%Y'))
...
<?php
$gtinc=0;
$lvl1inc="SELECT c.glno,c.glnm FROM `coa` c  where substring(c.glno,1,1) in('3') and c.lvl=2 ";
        ...
        { 
            while ($row2inc = $result2inc->fetch_assoc())
            {
                ...
                $amtqryi="select (sum(camt)-sum(damt)) amt from
                            (
                            select COALESCE(sum(d.amount),0) damt,0 camt from gldlt d,glmst m where m.VouchNo=d.VouchNo and  d.dr_cr='D'  and   d.glac='$gl2inc' and m.isfinancial in ('0','Y') and
   (m.transdt Between STR_TO_DATE('$fd', '%d/%m/%Y') and STR_TO_DATE('$td', '%d/%m/%Y'))
                            union all
                            select COALESCE(sum(d.amount),0) damt,0 camt from gldlt d,glmst m where m.VouchNo=d.VouchNo and  d.dr_cr='D' and d.glac in (select glno from coa where ctlgl='$gl2inc') and m.isfinancial in ('0','Y') and
   (m.transdt Between STR_TO_DATE('$fd', '%d/%m/%Y') and STR_TO_DATE('$td', '%d/%m/%Y'))
                            union all
                            select COALESCE(sum(d.amount),0) damt,0 camt from gldlt d,glmst m where m.VouchNo=d.VouchNo and  d.dr_cr='D' and d.glac in (select glno from coa where ctlgl in (select glno from coa where ctlgl='$gl2inc')) and m.isfinancial in ('0','Y') and
   (m.transdt Between STR_TO_DATE('$fd', '%d/%m/%Y') and STR_TO_DATE('$td', '%d/%m/%Y'))
                            union all
                            select 0 damt,COALESCE(sum(d.amount),0) camt from gldlt d,glmst m where m.VouchNo=d.VouchNo and  d.dr_cr='C'  and   d.glac='$gl2inc' and m.isfinancial in ('0','Y') and
   (m.transdt Between STR_TO_DATE('$fd', '%d/%m/%Y') and STR_TO_DATE('$td', '%d/%m/%Y'))
                            union all
                            select 0 damt,COALESCE(sum(d.amount),0) camt from gldlt d,glmst m where m.VouchNo=d.VouchNo and  d.dr_cr='C' and d.glac in(select glno from coa where ctlgl='$gl2inc') and m.isfinancial in ('0','Y') and
   (m.transdt Between STR_TO_DATE('$fd', '%d/%m/%Y') and STR_TO_DATE('$td', '%d/%m/%Y'))
                            union all
                            select 0 damt,COALESCE(sum(d.amount),0) camt from gldlt d,glmst m where m.VouchNo=d.VouchNo and  d.dr_cr='C' and d.glac in (select glno from coa where ctlgl in (select glno from coa where ctlgl='$gl2inc')) and m.isfinancial in ('0','Y') and
   (m.transdt Between STR_TO_DATE('$fd', '%d/%m/%Y') and STR_TO_DATE('$td', '%d/%m/%Y'))
                            ) u";
                    //echo  $amtqry;die;          
