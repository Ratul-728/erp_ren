...
else
{
    ...
    */
     $currSection = 'rpt_accounts_receivale';
    ...
    if ( isset( $_POST['export'] ) ) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('D1', 'Receivable Amounts');
       ...
       // echo  $qry;die;
        ...
        $objPHPExcel->getActiveSheet()->setTitle('Accounts Receivable Report ');
        $objPHPExcel->setActiveSheetIndex(0);
        $today=date("YmdHis");
        $fileNm="data/".'accounts_Receivable_report'.$today.'.xls'; 
    ...
    <span class="alertmsg">
                    ...
                    <!--  <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Accounting <i class="fa fa-angle-right"></i> Accounts Receivable Report </h6>
                       </div>
                        ...
                        <div class="pull-right grid-panel form-inline">
                            ...
                            <div class="form-group">
                            <input type="hidden" id="pdfsource" url="pdf_rpt_accounts_receivale.php">
...
function table_with_filter(url){
	...
	url = 'phpajax/datagrid_list_all.php?action=rpt_accounts_receivale';
	table_with_filter(url);	
        ...
        $('#from_dt').datetimepicker({
            ...
            url = 'phpajax/datagrid_list_all.php?action=rpt_accounts_receivale&dt_f=' + fdt;
            table_with_filter(url);
        });
