                	...
                	<form method="post" action="glmasterList.php" id="form1">
                     ...
                     <!-- <div class="row border">
                       ...
                       <div class="col-sm-3 text-nowrap">
                            <h6>Approval <i class="fa fa-angle-right"></i>All Customer Order</h6>
                       </div>
...
?>
     ...
     <!-- Datatable JS -->       
        ...
        $("#listTable").on("click",".actionbtn", function() {
            ...
            swal({
            title: "CO Approval",
            text: "Are you sure you want to proceed with this customer order? This action cannot be undone.",
            icon: "info",
            buttons: {
            cancel: {
              text: "Cancel",
