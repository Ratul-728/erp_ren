        ...
        <div class="container-fluid pagetop">
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <?php include_once 'phpajax/load_deal_view.php';?>
        <!-- /#end of panel -->
...
<?php }}?>
                        ...
                        <a href = "./dealList.php?pg=1&mod=2">
                            <input  dat a-to="pagetop" class="btn btn-lg btn-default top" type="button" name="home" value="&larr; Deal List" id="home" >
                        </a>
                        
                        <input class="btn btn-lg btn-default" type="button" name="cancel" value="Print"  id="cancel"  onclick="printDiv('printableArea')">
